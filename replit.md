...
- **Per-customer DB data**: All 9 customers have seeded data across 16 tables: wallet(9), wallet_transaction(16), wishlist(9), wishlist_item(9), booking(12), ticket(9), audit_log(13), analytics_event(9), dispute(3), permit(5), purchase_order(5), ins_policy(8), trade_in_request(6), enrollment(8), donation(6). B2B: company(5), invoice(6), quote(6).
