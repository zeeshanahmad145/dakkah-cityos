...
describe("GET /admin/subscriptions", () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks()
    mockModule = { listSubscriptions: jest.fn().mockResolvedValue([]) }
    mockReq = {
      query: {},
...
describe("POST /admin/subscriptions", () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks()
    mockModule = { createSubscriptions: jest.fn().mockResolvedValue({ id: "sub_new" }) }
    mockReq = {
...
describe("GET /admin/subscriptions/:id", () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks()
    mockModule = { listSubscriptions: jest.fn() }
    mockReq = {
      params: { id: "sub_1" },
      scope: { resolve: jest.fn().mockReturnValue(mockModule) },
      tenant: { id: "t1" },
...
describe("DELETE /admin/subscriptions/:id", () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks()
    mockModule = {
      listSubscriptions: jest.fn().mockResolvedValue([{ id: "sub_1", tenant_id: "t1" }]),
...
describe("POST /admin/subscriptions/:id/pause", () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks()
    mockQuery = { graph: jest.fn() }
    mockService = { updateSubscriptions: jest.fn().mockResolvedValue({ id: "sub_1", status: "paused" }) }
    mockReq = {
      params: { id: "sub_1" },
...
describe("POST /admin/subscriptions/:id/resume", () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks()
    mockQuery = { graph: jest.fn() }
    mockService = { updateSubscriptions: jest.fn().mockResolvedValue({ id: "sub_1", status: "active" }) }
    mockReq = {
      params: { id: "sub_1" },
      body: {},
      scope: {
...
describe("POST /admin/subscriptions/:id/change-plan", () => {
  ...
  beforeEach(() => {
    jest.clearAllMocks()
    mockQuery = { graph: jest.fn() }
    mockService = { updateSubscriptions: jest.fn().mockResolvedValue({ id: "sub_1", plan_id: "p2" }) }
    mockReq = {
      params: { id: "sub_1" },
      body: { new_plan_id: "p2" },
      scope: {
