...
function getFlashDealsSeedData() {
  ...
  return [
    ...
    { id: "fd-3", name: "Designer Leather Handbag", category: "fashion", thumbnail: "/seed-images/consignments/1548036328-c9fa89d128fa.jpg", original_price: 24999, sale_price: 12499, discount_percentage: 50, end_date: new Date(now + 2 * 60 * 60 * 1000).toISOString(), stock_remaining: 5, description: "Italian genuine leather, limited edition" },
  ...
  try {
    ...
    if (list.length > 0) {
      const deals = list.map((p: any) => ({
        ...p,
        thumbnail: p.thumbnail || p.metadata?.thumbnail || "/seed-images/flash-sales/1495474472287-4d71bcdd2085.jpg",
      }))
