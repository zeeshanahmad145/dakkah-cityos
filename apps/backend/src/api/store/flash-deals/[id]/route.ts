...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  ...
  try {
    ...
    const enriched = {
      ...item,
      thumbnail: item.thumbnail || item.metadata?.thumbnail || "/seed-images/flash-sales/1495474472287-4d71bcdd2085.jpg",
      reviews: [
