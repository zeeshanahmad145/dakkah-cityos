...
const SEED_DETAILS: Record<string, any> = {
  "fd-1": {
    ...
    description:
      "Premium ANC headphones with 30hr battery life, plush ear cups, and active noise cancellation.",
    features: [
    ...
    reviews: [
      ...
      },
      {
        author: "Layla R.",
        rating: 4,
        comment: "Worth every riyal at this price.",
    ...
    reviews: [
      {
        author: "Fatima K.",
        rating: 5,
        comment: "Tracks everything perfectly!",
        created_at: "2026-01-12T00:00:00Z",
      },
      {
        author: "Nasser J.",
        rating: 4,
        comment: "Great value for the features.",
      ...
      },
      {
        author: "Faisal W.",
        rating: 4,
        comment: "Battery lasts about 5 days.",
        created_at: "2025-12-25T00:00:00Z",
      },
      {
        author: "Dana Y.",
        rating: 5,
        comment: "Excellent for daily workouts.",
...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  ...
  if (detail)
    return res.json({ flash_deal: enrichDetailItem(detail, "flash-deals") });
  ...
  try {
    ...
    const enriched = {
      ...
      thumbnail:
        ...
        "/seed-images/flash-sales/1495474472287-4d71bcdd2085.jpg",
      reviews: [
        {
          author: "Khalid M.",
          rating: 5,
          comment: "Amazing deal, couldn't pass it up!",
          created_at: "2026-01-15T00:00:00Z",
        },
        {
          author: "Sara A.",
          rating: 4,
          comment: "Great value at the flash sale price.",
          created_at: "2026-01-10T00:00:00Z",
        },
        {
          author: "Omar H.",
          rating: 5,
          comment: "Product quality exceeded expectations.",
          created_at: "2026-01-05T00:00:00Z",
        },
        {
          author: "Layla R.",
        ...
        },
        {
          author: "Ahmed S.",
          rating: 5,
          comment: "Fast shipping too. Highly recommend.",
          created_at: "2025-12-20T00:00:00Z",
        },
      ],
    };
