...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  ...
  try {
    ...
    const result = featuredVendors.length > 0 ? sanitizeList(featuredVendors, "vendors") : SEED_FEATURED_VENDORS.slice(0, Number(limit))
