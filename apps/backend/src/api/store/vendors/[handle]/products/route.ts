...
const SEED_VENDOR_PRODUCTS = [
  { id: "vp-1", title: "Wireless Bluetooth Headphones", handle: "wireless-bluetooth-headphones", description: "Premium noise-cancelling wireless headphones with 30-hour battery life.", thumbnail: "/seed-images/vendors/1531297484001-80022131f5a1.jpg", status: "published", variants: [{ id: "vp-1-v1", title: "Default", prices: [{ amount: 7999, currency_code: "usd" }] }] },
  { id: "vp-2", title: "Organic Cotton T-Shirt", handle: "organic-cotton-tshirt", description: "Sustainably sourced 100% organic cotton t-shirt, available in multiple colors.", thumbnail: "/seed-images/vendors/1542601906990-b4d3fb778b09.jpg", status: "published", variants: [{ id: "vp-2-v1", title: "Default", prices: [{ amount: 2999, currency_code: "usd" }] }] },
  { id: "vp-3", title: "Artisan Ceramic Mug", handle: "artisan-ceramic-mug", description: "Handcrafted ceramic mug with unique glazing patterns, 12oz capacity.", thumbnail: "/seed-images/vendors/1513364776144-60967b0f800f.jpg", status: "published", variants: [{ id: "vp-3-v1", title: "Default", prices: [{ amount: 2499, currency_code: "usd" }] }] },
  { id: "vp-4", title: "Smart Fitness Tracker", handle: "smart-fitness-tracker", description: "Advanced fitness tracker with heart rate monitor, GPS, and sleep tracking.", thumbnail: "/seed-images/vendors/1558171813-4c088753af8f.jpg", status: "published", variants: [{ id: "vp-4-v1", title: "Default", prices: [{ amount: 12999, currency_code: "usd" }] }] },
  { id: "vp-5", title: "Gourmet Coffee Blend", handle: "gourmet-coffee-blend", description: "Single-origin arabica coffee beans, medium roast with notes of chocolate and caramel.", thumbnail: "/seed-images/vendors/1504674900247-0877df9cc836.jpg", status: "published", variants: [{ id: "vp-5-v1", title: "Default", prices: [{ amount: 1899, currency_code: "usd" }] }] },
]
