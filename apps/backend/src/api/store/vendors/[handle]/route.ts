...
const SEED_VENDORS = [
  {
    ...
    description:
      "Premium consumer electronics, gadgets, and accessories from top global brands. Authorized retailer with warranty support.",
  ...
  },
  {
    ...
    description:
      "Eco-friendly home products, organic goods, and sustainable lifestyle essentials for conscious consumers.",
  ...
  },
  {
    ...
    description:
      "Handmade jewelry, pottery, textiles, and artisanal goods from local craftspeople and independent artisans.",
  ...
  },
  {
    ...
    description:
      "Curated fashion collections featuring contemporary designs and trending styles for the modern wardrobe.",
  ...
  },
  {
    ...
    description:
      "Premium specialty foods, artisan ingredients, and curated gourmet gift baskets for food enthusiasts.",
...
const SEED_PRODUCTS: Record<string, any[]> = {
  "tech-haven": [
    {
      ...
      price: 34900,
      thumbnail: "/seed-images/vendors/1531297484001-80022131f5a1.jpg",
    ...
    },
    {
      ...
      handle: "4k-smart-tv",
      price: 189900,
      thumbnail: "/seed-images/vendors/1518770660439-4636190af475.jpg",
      category: "Electronics",
    },
    {
      id: "vp-3",
  ...
  "green-living": [
    {
      ...
      handle: "bamboo-utensils",
      price: 4500,
      thumbnail: "/seed-images/vendors/1542601906990-b4d3fb778b09.jpg",
      category: "Home",
    },
    {
      id: "vp-6",
      title: "Organic Cotton Bed Sheets",
      handle: "organic-sheets",
      price: 12900,
      thumbnail: "/seed-images/vendors/1441974231531-c6227db76b6e.jpg",
      category: "Home",
    },
    {
      id: "vp-7",
  ...
  "artisan-crafts": [
    {
      ...
      handle: "ceramic-vase",
      price: 8900,
      thumbnail: "/seed-images/vendors/1513364776144-60967b0f800f.jpg",
      category: "Art",
    },
    {
      id: "vp-9",
      title: "Woven Wool Tapestry",
      handle: "wool-tapestry",
      price: 15900,
      thumbnail: "/seed-images/vendors/1441984904996-e0b6ba687e04.jpg",
      category: "Handmade",
    },
    {
      id: "vp-10",
  ...
  "fashion-forward": [
    {
      ...
      price: 45900,
      thumbnail: "/seed-images/vendors/1558171813-4c088753af8f.jpg",
      category: "Fashion",
    },
    {
      id: "vp-12",
  ...
  "gourmet-delights": [
    {
      id: "vp-14",
      title: "Artisan Truffle Oil Collection",
      handle: "truffle-oil",
      price: 6900,
      thumbnail: "/seed-images/vendors/1504674900247-0877df9cc836.jpg",
      category: "Gourmet",
    },
    {
      id: "vp-15",
      title: "Premium Saffron Gift Box",
      handle: "saffron-gift",
      price: 14900,
      thumbnail: "/seed-images/vendors/1555244162-803834f70033.jpg",
      category: "Food",
    },
    {
      id: "vp-16",
  ...
  "al-baik": [
    {
      id: "vp-17",
      title: "Broasted Chicken Meal",
      handle: "broasted-meal",
      price: 2900,
      thumbnail: "/seed-images/vendors/1626645738196-c2a7c87a8f58.jpg",
      category: "Food",
    },
    {
      id: "vp-18",
      title: "Shrimp Meal Box",
      handle: "shrimp-meal",
      price: 3500,
      thumbnail: "/seed-images/vendors/1513639776629-7b61b0ac49cb.jpg",
      category: "Food",
    },
    {
      id: "vp-19",
...
const SEED_REVIEWS = [
  {
    ...
    content:
      "Outstanding products and fast shipping. Will definitely order again.",
  ...
  },
  {
    ...
    content:
      "Great selection and reasonable prices. Customer service was helpful.",
  ...
  },
  {
    ...
    rating: 5,
    title: "Best vendor on the platform",
    content:
      "I've been shopping here for months. Consistently excellent quality and reliable delivery.",
  ...
  },
  {
    ...
    rating: 4,
    title: "Good but shipping could be faster",
    content:
      "Products are great quality. Only wish shipping was a bit quicker to my area.",
  ...
  },
  {
    ...
    content:
      "Premium products at fair prices. The packaging was also very impressive.",
  ...
  {
    id: "vr-6",
    customer_name: "Noura Al-Qahtani",
    rating: 3,
    title: "Decent overall",
    content:
      "Product was fine but took longer than expected to arrive. Communication could improve.",
  ...
  {
    id: "vr-7",
    customer_name: "Youssef Bakr",
    rating: 5,
    title: "Repeat customer!",
    content:
      "Third time ordering from this vendor. Never disappointed. Top notch quality.",
  ...
  {
    id: "vr-8",
    customer_name: "Layla Al-Otaibi",
    rating: 4,
    title: "Love the variety",
    content:
      "Great range of products to choose from. Prices are competitive too.",
    created_at: "2025-08-15T15:10:00Z",
    is_verified_purchase: true,
    helpful_count: 6,
  },
];
...
function enrichVendorProfile(raw: any, handle: string) {
  ...
  const products =
    SEED_PRODUCTS[handle] || SEED_PRODUCTS[Object.keys(SEED_PRODUCTS)[0]] || [];
  return {
    ...raw,
    name,
    title: name,
    ...
    thumbnail:
      raw.logo_url ||
      raw.banner_url ||
      "/seed-images/vendors/1531297484001-80022131f5a1.jpg",
    product_count: raw.total_products || products.length,
    products,
    reviews: SEED_REVIEWS,
    policies: {
      shipping:
        "Free shipping on orders over SAR 200. Standard delivery 2-5 business days.",
...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  ...
  try {
    ...
    if (vendorList.length === 0) {
      const seed =
        SEED_VENDORS.find((v) => v.handle === handle || v.id === handle) ||
        SEED_VENDORS[0];
    ...
    const sanitized = sanitizeImageUrls(
      publicProfile,
      "vendors",
      ["logo_url", "banner_url"],
      0,
