...
const SEED_VENDOR_REVIEWS = [
  {
    ...
    content:
      "Ordered several items and everything arrived in perfect condition. The packaging was eco-friendly too. Will definitely order again!",
    is_verified: true,
    helpful_count: 24,
  ...
  },
  {
    id: "vr-2",
    rating: 4,
    title: "Great products, good service",
    content:
      "The product quality is outstanding. Delivery took a day longer than expected but customer service was very responsive.",
    is_verified: true,
    helpful_count: 18,
  ...
  },
  {
    ...
    content:
      "I've been buying from this vendor for months now. Consistently high quality and great prices. Highly recommended!",
    is_verified: true,
    helpful_count: 32,
  ...
  },
  {
    ...
    content:
      "Nice selection of products at reasonable prices. The descriptions are accurate and what you see is what you get.",
    is_verified: false,
    helpful_count: 11,
  ...
  },
  {
    ...
    content:
      "Had a small issue with my order and the vendor resolved it within hours. Amazing customer service experience!",
    is_verified: true,
    helpful_count: 15,
...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  ...
  try {
    ...
    if (vendorList.length === 0 || vendorList[0].status !== "active") {
      return res.json(
        getSeedReviewResponse(handle, Number(offset), Number(limit)),
      );
    }
