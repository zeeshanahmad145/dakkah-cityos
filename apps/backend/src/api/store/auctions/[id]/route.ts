...
const SEED_DATA = [
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Stunning timepiece, exactly as described. The auction process was transparent and exciting.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Authentic Swiss craftsmanship. The gold case is absolutely magnificent in person.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Beautiful watch with excellent provenance. Bidding was competitive but fair.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "The automatic movement keeps perfect time. A true collector's piece worth every bid.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Impressive quality and the sapphire crystal is flawless. Delivery was well-packaged.",
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "The colors are breathtaking in person. Authentication was thorough and reassuring.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Gallery-quality framing adds tremendous value. A centerpiece for any collection.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Exceptional abstract work from a pivotal era. The auction house provided excellent provenance.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Beautiful piece that exceeded my expectations. Secure shipping and handling.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "A museum-worthy painting. The bidding experience was thrilling and well-managed.",
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "A dream car in pristine condition. The restoration work is absolutely flawless.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Matching numbers engine and original interior — a true find. Worth every penny.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Show-quality paint job and the engine purrs beautifully. A collector's dream come true.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Exceptional muscle car. The documentation and history file were comprehensive.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Classic American power. The auction platform made bidding smooth and transparent.",
  ...
  },
  {
    ...
    metadata: {
      thumbnail: "/seed-images/auctions/1560472355-536de3962603.jpg",
    },
    thumbnail: "/seed-images/auctions/1560472355-536de3962603.jpg",
    reviews: [
      {
        author: "Lena Goldstein",
        rating: 5,
        comment:
          "The emeralds have an incredible deep green color. GIA certification gives full confidence.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Exquisite craftsmanship. The diamond settings are precise and the necklace catches light beautifully.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Gorgeous piece. The luxury case presentation made it feel truly special.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "VS1 diamonds are brilliantly clear. A statement piece for any formal occasion.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Stunning design and the Colombian emeralds are vivid. Sealed bid process was fair.",
  ...
  },
  {
    ...
    reviews: [
      {
        author: "Prof. William Hart",
        rating: 5,
        comment:
          "Museum-quality collection spanning three great civilizations. Each coin is meticulously graded.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "The Islamic period coins are particularly rare. Excellent certification documentation.",
        created_at: "2025-01-06T00:00:00Z",
      },
      {
        author: "Helen Papadopoulos",
        rating: 5,
        comment:
          "Byzantine gold coins in remarkable condition. A numismatist's dream collection.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Each coin tells a story of its era. The Dutch auction format kept prices reasonable.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Impressive provenance and condition. The Roman coins alone are worth the collection price.",
...
const SEED_REVIEWS = [
  {
    ...
    rating: 5,
    comment:
      "Exceptional item, exactly as described. The auction process was transparent and exciting.",
    created_at: "2025-01-15T00:00:00Z",
  },
  {
    author: "Victoria Chen",
    rating: 5,
    comment: "Superb quality. Authentication was thorough and reassuring.",
    created_at: "2025-01-12T00:00:00Z",
  },
  {
    author: "Pierre Dubois",
    rating: 4,
    comment:
      "Beautiful piece. Bidding was competitive but fair and well-managed.",
    created_at: "2025-01-10T00:00:00Z",
  },
  {
    author: "Amira Nasser",
    rating: 5,
    comment: "A truly rare find. The platform made the process smooth.",
    created_at: "2025-01-08T00:00:00Z",
  },
  {
    author: "Marco Bianchi",
    rating: 4,
    comment: "Impressive quality. Delivery was prompt and well-packaged.",
    created_at: "2025-01-05T00:00:00Z",
  },
];
  ...
  try {
    ...
    if (!item) {
      ...
      return res.json({
        item: {
          ...seedItem,
          bids: generateSeedBids(
            seedItem.current_price,
            seedItem.bid_increment,
            seedItem.bid_count,
          ),
        },
      });
    ...
    const enriched = {
      ...
      bids:
        bidList.length > 0
          ? bidList
          : generateSeedBids(
              Number(item.current_price || item.starting_price || 10000),
              Number(item.bid_increment || 1000),
              Number(item.total_bids || 5),
            ),
