...
const SEED_DATA = [
  {
    ...
    reviews: [{ author: "Homeowner", rating: 5, comment: "Reliable service with excellent smart meter features.", created_at: "2024-06-15T00:00:00Z" }, { author: "Business Owner", rating: 4, comment: "Competitive rates and great 24/7 support.", created_at: "2024-06-10T00:00:00Z" }, { author: "Property Manager", rating: 5, comment: "Never had an outage issue. Very dependable.", created_at: "2024-05-28T00:00:00Z" }, { author: "Green Advocate", rating: 4, comment: "Love the green energy options.", created_at: "2024-05-20T00:00:00Z" }, { author: "Tenant", rating: 5, comment: "Budget billing makes it easy to plan expenses.", created_at: "2024-05-15T00:00:00Z" }],
  },
  {
    id: "util-seed-2",
  ...
  },
  {
    ...
    reviews: [{ author: "Business User", rating: 5, comment: "Crystal clear calls and great international rates.", created_at: "2024-09-10T00:00:00Z" }, { author: "Office Manager", rating: 4, comment: "Voicemail to email feature is very useful.", created_at: "2024-09-05T00:00:00Z" }, { author: "Sales Rep", rating: 5, comment: "Call forwarding works perfectly.", created_at: "2024-08-28T00:00:00Z" }, { author: "Receptionist", rating: 4, comment: "Reliable service with no dropped calls.", created_at: "2024-08-20T00:00:00Z" }, { author: "Consultant", rating: 5, comment: "Unlimited calling saves us a fortune.", created_at: "2024-08-15T00:00:00Z" }],
  },
]
