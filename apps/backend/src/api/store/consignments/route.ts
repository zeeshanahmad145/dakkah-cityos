...
const SEED_CONSIGNMENTS = [
  {
    ...
    description:
      "1978 Rolex Submariner in excellent condition with original box and papers.",
  ...
  },
  {
    ...
    description:
      "Authentic mid-century Eames lounge chair and ottoman in walnut and black leather.",
    category: "Furniture",
    condition: "Good",
  ...
  },
  {
    ...
    description:
      "Gently used Louis Vuitton Neverfull MM in Damier Ebene with original dust bag.",
  ...
  },
  {
    ...
    description:
      "Authenticated Andy Warhol Campbell's Soup screen print, numbered edition.",
  ...
  },
  {
    ...
    description:
      "Apple MacBook Pro 16-inch with M3 Max chip, 64GB RAM, barely used with AppleCare+.",
  ...
  if (!customerId) {
    return res.json({
      ...
      public_info: {
        ...
        description:
          "Sell your items through our marketplace with our consignment program.",
        how_it_works: [
