...
const submitQuoteSchema = z.object({}).strict();
...
const SEED_QUOTES = [
  {
    ...
    description:
      "Custom quote for complete office furniture setup including desks, chairs, and storage units.",
    status: "pending",
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "The quote was detailed and transparent. No hidden fees. Very professional.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Quick turnaround on the quote. Bulk discount was very competitive.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Delivery within 2 weeks as promised. Furniture quality exceeded expectations.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Great pricing for the office package. Would have liked more customization options.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Our procurement team was impressed. Seamless ordering process from quote to delivery.",
  ...
  },
  {
    ...
    description:
      "Technology refresh quote for laptops, monitors, and peripherals.",
    status: "approved",
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Volume pricing was excellent. All 25 laptops arrived configured and ready to use.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Good equipment quality. The 30-day NET terms made budgeting easy.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Smooth procurement process. Account manager was responsive and helpful.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Monitors are excellent quality. Wireless peripherals work well out of the box.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Best IT equipment vendor we've worked with. Quote to delivery was seamless.",
  ...
  },
  {
    ...
    description:
      "Annual supply contract for packaging materials and warehouse consumables.",
    status: "draft",
    ...
    items: [
      ...
      {
        name: "Packing Tape (48-roll case)",
        quantity: 200,
        unit_price: 3500,
        total: 700000,
      },
      {
        name: "Bubble Wrap (300m roll)",
        quantity: 100,
        unit_price: 4500,
        total: 450000,
      },
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment:
          "Good pricing for annual contract. Quarterly delivery schedule works well for our warehouse.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "15% discount on the annual contract saved us significantly. Quality materials.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Reliable supply chain. Haven't had a single late delivery in 6 months.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "The bulk pricing is unbeatable. Boxes and packing materials are top quality.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Good contract terms. Would appreciate more flexible delivery scheduling options.",
  ...
  },
  {
    ...
    description:
      "Audio-visual equipment rental quote for corporate annual conference.",
    status: "submitted",
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "LED video walls were stunning. Technical support during the event was outstanding.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Great AV equipment quality. Setup and teardown was handled professionally.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Our conference was a huge success thanks to the excellent AV setup.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Good equipment but the 10% discount could have been more competitive.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Professional from start to finish. Will definitely use for our next event.",
  ...
  },
  {
    ...
    description:
      "Branded merchandise order for company swag including apparel and accessories.",
    status: "expired",
    ...
    reviews: [
      {
        ...
        rating: 4,
        comment:
          "Quality merchandise and good bulk pricing. T-shirts were comfortable and well-printed.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Embroidered caps looked fantastic. Our team loved the branded swag.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Good variety of products. Tote bags were especially popular at our event.",
      ...
      },
      {
        ...
        rating: 3,
        comment:
          "Products were good but the quote expired before we could finalize. Need longer validity.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "15% discount on bulk order was great. Will request updated pricing soon.",
