...
const SEED_POIS = [
  {
    ...
    description:
      "Iconic skyscraper in the heart of Riyadh with observation deck, luxury shopping mall, and fine dining restaurants. The tower stands at 267 meters and is one of the most recognizable landmarks in the city.",
    poi_type: "landmark",
    category: "attraction",
    thumbnail: "/seed-images/content/1586724237569-f3d0c1dee8c6.jpg",
    images: ["/seed-images/content/1586724237569-f3d0c1dee8c6.jpg"],
  ...
  },
  {
    ...
    description:
      "Beautiful waterfront promenade along the Red Sea coast, perfect for walking, cycling, and enjoying seaside views. Stretches over 30 km with parks, sculptures, and recreational areas.",
    poi_type: "park",
    category: "recreation",
    thumbnail: "/seed-images/content/1578662996442-48f60103fc96.jpg",
    images: ["/seed-images/content/1578662996442-48f60103fc96.jpg"],
  ...
  },
  {
    ...
    description:
      "Historic clay and mud-brick fortress in the center of Riyadh, now a museum showcasing Saudi heritage and the founding of the kingdom.",
    poi_type: "museum",
    category: "culture",
    thumbnail: "/seed-images/content/1548013146-72479768bada.jpg",
    images: ["/seed-images/content/1548013146-72479768bada.jpg"],
  ...
  },
  {
    ...
    description:
      "Massive entertainment and leisure destination featuring dining, shopping, events, and world-class entertainment experiences for all ages.",
    poi_type: "entertainment",
    category: "entertainment",
    thumbnail: "/seed-images/content/1519167758481-83f550bb49b3.jpg",
    images: ["/seed-images/content/1519167758481-83f550bb49b3.jpg"],
  ...
  },
  {
    ...
    description:
      "Modern business hub and architectural landmark featuring stunning skyscrapers and corporate offices in the heart of Riyadh.",
    poi_type: "business",
    category: "business",
    thumbnail: "/seed-images/b2b/1486406146926-c627a92ad1ab.jpg",
    images: ["/seed-images/b2b/1486406146926-c627a92ad1ab.jpg"],
  ...
  },
  {
    ...
    images: ["/seed-images/content/1682687220742-aba13b6e50ba.jpg"],
...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  ...
  try {
    ...
    if (!poi) {
      ...
      return res.json({
        poi: { ...seed, id, lat: seed.latitude, lng: seed.longitude },
        item: { ...seed, id, lat: seed.latitude, lng: seed.longitude },
      });
    }

    const normalized = enrichDetailItem(
      { ...poi, lat: poi.latitude, lng: poi.longitude },
      "places",
    );
