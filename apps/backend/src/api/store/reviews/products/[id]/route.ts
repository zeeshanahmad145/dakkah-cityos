  ...
  return [
    {
      ...
      content:
        "Exceeded all my expectations. The quality is outstanding and it arrived quickly. Would definitely recommend to anyone looking for a reliable option.",
    ...
    },
    {
      ...
      content:
        "Really solid product for the price. Minor improvements could be made to the packaging, but overall I'm very satisfied with my purchase.",
    ...
    },
    {
      ...
      content:
        "I've tried many similar products and this one stands out. The attention to detail is remarkable and customer service was excellent when I had a question.",
    ...
    },
    {
      ...
      title: "Solid quality",
      content:
        "Works exactly as described. Setup was straightforward and it has been performing well for over a month now. Happy with the purchase.",
    ...
    },
    {
      ...
      content:
        "From ordering to delivery, the whole experience was seamless. The product itself is top-notch and looks even better in person than in the photos.",
    ...
    },
    {
      ...
      content:
        "It does what it's supposed to do but I expected a bit more polish at this price point. Not bad, just not exceptional. Would still consider buying again.",
    ...
    },
    {
      ...
      title: "A must-have!",
      content:
        "This is exactly what I was looking for. High quality materials, beautiful design, and it works perfectly. Already recommended it to friends and family.",
    ...
    },
    {
      ...
      content:
        "Good build quality and works as advertised. The only minor issue was that the instructions could be clearer, but I figured it out. Definitely worth it.",
    ...
    },
    {
      ...
      content:
        "I was hesitant to order online but I'm so glad I did. The product arrived in perfect condition and is even better quality than I anticipated. Five stars!",
    ...
    },
    {
      ...
      content:
        "Using this daily and it holds up great. The design is sleek and functional. Would have given 5 stars if shipping was a bit faster.",
    ...
    },
    {
      ...
      content:
        "Bought this as a gift and the recipient was thrilled. Premium feel and great presentation. Will definitely be ordering more for other occasions.",
    ...
    },
    {
      ...
      content:
        "Consistent quality and fair pricing. I appreciate the attention to detail in the design. This is my second purchase and both times I've been satisfied.",
