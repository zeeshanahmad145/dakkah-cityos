...
const SEED_DATA = [
  { id: "ins-1", name: "Comprehensive Health Insurance", description: "Full medical coverage including hospitalization, outpatient care, dental, and vision for individuals and families.", insurance_type: "health", coverage_details: ["Hospitalization up to 500,000 SAR", "Outpatient visits covered", "Dental & vision included"], features: ["No waiting period", "Worldwide coverage", "Family plans available", "24/7 telemedicine"], exclusions: ["Pre-existing conditions (first 12 months)", "Cosmetic procedures", "Experimental treatments", "Self-inflicted injuries"], currency_code: "SAR", metadata: { thumbnail: "/seed-images/fitness%2F1576091160399-112ba8d25d1d.jpg", price: 15000, rating: 4.8 }, is_active: true },
  ...
  { id: "ins-3", name: "Home Protection Plan", description: "Safeguard your property against natural disasters, theft, fire, and accidental damage with flexible coverage.", insurance_type: "home", coverage_details: ["Structure & contents covered", "Natural disaster protection", "Liability coverage included"], features: ["Replacement cost coverage", "Temporary housing", "Personal property protection", "Identity theft coverage"], exclusions: ["Intentional damage", "Government seizure", "Nuclear hazards", "Normal wear and deterioration"], currency_code: "SAR", metadata: { thumbnail: "/seed-images/financial-products%2F1560518883-ce09059eeffa.jpg", price: 8000, rating: 4.7 }, is_active: true },
