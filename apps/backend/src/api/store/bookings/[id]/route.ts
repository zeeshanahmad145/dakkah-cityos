...
const SEED_SERVICES = [
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Incredible deep tissue massage. The therapist was skilled and the spa ambiance was perfect.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Best massage I've had in Riyadh. Completely relieved my chronic back tension.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Very professional service. The 60-minute session was well worth the price.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Serenity Spa lives up to its name. Walked out feeling completely rejuvenated.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Great therapists and clean facilities. Booking was easy and confirmation was prompt.",
  ...
  },
  {
    ...
    reviews: [
      {
        author: "Ahmed Startup",
        rating: 5,
        comment:
          "ProGrowth Advisors transformed our business strategy. The consultation was insightful and actionable.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "45 minutes of pure value. The strategist understood our market challenges immediately.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Virtual format worked perfectly. Got a comprehensive growth roadmap from the session.",
        created_at: "2025-01-02T00:00:00Z",
      },
      {
        author: "Layla Business",
        rating: 5,
        comment:
          "Worth every riyal. Their market analysis revealed opportunities we hadn't considered.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Professional and knowledgeable consultants. Follow-up materials were very helpful.",
  ...
  },
  {
    ...
    reviews: [
      {
        author: "Hana Al-Otaibi",
        rating: 5,
        comment:
          "Wonderful yoga class. The instructor blended Hatha and Vinyasa styles beautifully.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Great for beginners. The mindfulness meditation at the end was deeply relaxing.",
        created_at: "2025-01-09T00:00:00Z",
      },
      {
        author: "Maryam Fitness",
        rating: 5,
        comment:
          "ZenFit Studio has the best yoga in Jeddah. The Corniche location is stunning.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Perfect class size of 15 max. Personal attention from the instructor was appreciated.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Transformative experience. The breathwork techniques have improved my daily routine.",
  ...
  },
  {
    ...
    reviews: [
      {
        author: "Khalid Photography",
        rating: 5,
        comment:
          "Lens & Light Studio captured our family portraits beautifully. The photographer was patient and creative.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Outstanding event photography. Every important moment was captured perfectly.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Professional product shots for our e-commerce store. Quick turnaround on editing.",
        created_at: "2025-01-01T00:00:00Z",
      },
      {
        author: "Nadia Portraits",
        rating: 5,
        comment:
          "The on-location convenience is a huge plus. Digital delivery was fast and high quality.",
        created_at: "2024-12-24T00:00:00Z",
      },
      {
        author: "Mark Corporate",
        rating: 4,
        comment:
          "Great corporate headshots for our team. The photographer knew exactly how to pose everyone.",
    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "Glamour Hair Lounge is my go-to for special occasions. The stylists are incredibly talented.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Great precision cut and the consultation was thorough. Kingdom Centre location is convenient.",
      ...
      },
      {
        ...
        rating: 5,
        comment:
          "Luxury hair treatment that made my hair feel amazing. Award-winning stylists for a reason.",
      ...
      },
      {
        ...
        rating: 4,
        comment:
          "Excellent color work. They used premium products and the results lasted weeks.",
      ...
      },
      {
        ...
        rating: 3,
        comment:
          "Good service but can get busy. Booking in advance is recommended for weekends.",
  ...
  },
  {
    ...
    reviews: [
      {
        author: "Youssef Calligraphy",
        rating: 5,
        comment:
          "Al-Khat Academy is a treasure. Learning Naskh script from master calligraphers was unforgettable.",
        created_at: "2025-01-10T00:00:00Z",
      },
      {
        author: "Emma Art",
        rating: 5,
        comment:
          "Beautiful cultural experience in Diriyah. All materials were provided and the instruction was excellent.",
        created_at: "2025-01-04T00:00:00Z",
      },
      {
        author: "Hassan Culture",
        rating: 4,
        comment:
          "The Thuluth script workshop was challenging but rewarding. Small class size ensured personal attention.",
        created_at: "2024-12-28T00:00:00Z",
      },
      {
        author: "Priya Creative",
        rating: 5,
        comment:
          "An art form that connects you to centuries of tradition. The workshop was well-structured.",
        created_at: "2024-12-20T00:00:00Z",
      },
      {
        author: "Alex Workshop",
        rating: 4,
        comment:
          "Great introduction to Arabic calligraphy. Would love to see advanced level classes offered.",
...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  ...
  try {
    ...
    try {
      service = await bookingModule.retrieveServiceProduct(
    ...
    if (booking.provider_id) {
      try {
        provider = await bookingModule.retrieveServiceProvider(
          booking.provider_id,
        );
      } catch {}
    }
