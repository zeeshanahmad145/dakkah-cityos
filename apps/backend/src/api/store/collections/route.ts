...
const COLLECTION_THUMBNAILS: Record<string, string> = {
  "riyadh-essentials": "/seed-images/content%2F1586724237569-f3d0c1dee8c6.jpg",
  "winter-collection": "/seed-images/content%2F1548013146-72479768bada.jpg",
  "electronics-tech": "/seed-images/content%2F1573164713988-8665fc963095.jpg",
}
...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  try {
    ...
    const enriched = (collections || []).map((c: any) => ({
      ...c,
      thumbnail: COLLECTION_THUMBNAILS[c.handle] || "/seed-images/content%2F1558171813-4c088753af8f.jpg",
    }))
    ...
    const fallbackCollections = [
      {
        ...
        thumbnail: "/seed-images/content%2F1586724237569-f3d0c1dee8c6.jpg",
        metadata: null,
      ...
      },
      {
        ...
        thumbnail: "/seed-images/content%2F1548013146-72479768bada.jpg",
        metadata: null,
        created_at: "2025-01-01T00:00:00Z",
        updated_at: "2025-01-01T00:00:00Z",
      },
