...
const SEED_ITEMS = [
  ...
  },
  {
    ...
    name: "PlayStation 5",
    category: "gaming",
    thumbnail: "https://images.unsplash.com/photo-1593642532744-d377ab507dc8?w=800&h=600&fit=crop",
...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  ...
  if (!customerId) {
    return res.json({
      ...
      public_info: {
        eligible_categories: [
          { name: "Electronics", description: "Smartphones, laptops, tablets and more", estimated_value_range: "$50 - $800", thumbnail: "https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800&h=600&fit=crop" },
          { name: "Automotive", description: "Vehicles, parts, and accessories", estimated_value_range: "$100 - $25000", thumbnail: "https://images.unsplash.com/photo-1489824904134-891ab64532f1?w=800&h=600&fit=crop" },
          ...
          { name: "Appliances", description: "Home appliances in working condition", estimated_value_range: "$30 - $400", thumbnail: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?w=800&h=600&fit=crop" },
        ],
        how_it_works: [
