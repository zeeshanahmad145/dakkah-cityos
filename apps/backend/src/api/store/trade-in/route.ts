...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  ...
  if (!customerId) {
    return res.json({
      ...
      public_info: {
        eligible_categories: [
          { name: "Electronics", description: "Smartphones, laptops, tablets and more", estimated_value_range: "$50 - $800", thumbnail: "/seed-images/bundles%2F1519389950473-47ba0277781c.jpg" },
          { name: "Automotive", description: "Vehicles, parts, and accessories", estimated_value_range: "$100 - $25000", thumbnail: "/seed-images/auctions%2F1489824904134-891ab64532f1.jpg" },
          { name: "Furniture", description: "Home and office furniture", estimated_value_range: "$25 - $500", thumbnail: "/seed-images/classifieds%2F1555041469-a586c61ea9bc.jpg" },
          { name: "Appliances", description: "Home appliances in working condition", estimated_value_range: "$30 - $400", thumbnail: "/seed-images/trade-in%2F1524758631624-e2822e304c36.jpg" },
        ],
        how_it_works: [
