...
const SEED_ITEMS = [
  { id: "ti-seed-1", name: "iPhone 15 Pro", category: "phones", thumbnail: "/seed-images/auctions%2F1523275335684-37898b6baf30.jpg", description: "Trade in your iPhone 15 Pro for store credit. All storage sizes accepted.", condition_requirements: "Powers on, no cracks, all buttons functional", estimated_value_min: 150000, estimated_value_max: 280000, currency: "SAR", status: "active" },
