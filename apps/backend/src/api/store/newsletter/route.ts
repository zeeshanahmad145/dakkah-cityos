...
const SEED_NEWSLETTERS = [
  ...
  {
    id: "nl-2",
    title: "Style & Fashion Update",
    description:
      "Curated fashion trends, seasonal collections, and exclusive deals from top designers and brands.",
    frequency: "weekly",
  ...
  },
  {
    ...
    title: "Foodie Finds",
    description:
      "Discover new restaurants, recipes, and food trends in your city every Wednesday.",
    frequency: "weekly",
    subscriber_count: 6200,
    category: "food",
    thumbnail: "/seed-images/grocery/1542838132-92c53300491e.jpg",
    created_at: "2025-02-01T00:00:00Z",
  },
  {
    id: "nl-4",
    title: "Wellness & Health Brief",
    description:
      "Expert health tips, workout routines, and wellness research to keep you at your best.",
    frequency: "biweekly",
    subscriber_count: 15300,
    category: "health",
  ...
  },
  {
    ...
    title: "Market Watch",
    description:
      "Daily financial market analysis, investment tips, and economic updates from industry experts.",
    frequency: "daily",
    subscriber_count: 22100,
    category: "finance",
    thumbnail: "/seed-images/financial-products/1559526324-4b87b5e36e44.jpg",
...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  try {
    ...
    if (notifService?.listPreferences) {
      const items = await notifService.listPreferences({
        channel: "email",
