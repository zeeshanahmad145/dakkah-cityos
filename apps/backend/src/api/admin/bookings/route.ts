...
export async function GET(req: MedusaRequest, res: MedusaResponse) {
  try {
    ...
    const { status, customer_id, provider_id } = req.query as Record<string, string | undefined>
    ...
    const bookings = await bookingModule.listBookings(filters, { skip: offset, take: limit })
