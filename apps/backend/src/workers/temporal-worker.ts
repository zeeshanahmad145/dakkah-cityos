...
const activityImplementations = {
  async syncProductToPayload(input: any) {
    logger.info(
      `[TemporalWorker] Executing syncProductToPayload: ${input.productId}`,
    );
    try {
      ...
      const existing = await client
        .get("/api/product-content", {
          params: {
            where: { medusaProductId: { equals: input.productId } },
            limit: 1,
          },
        })
        .then((r) => r.data.docs?.[0])
        .catch(() => null);
      ...
      logger.error(
        `[TemporalWorker] syncProductToPayload failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async deleteProductFromPayload(input: any) {
    logger.info(
      `[TemporalWorker] Executing deleteProductFromPayload: ${input.productId}`,
    );
    try {
      const client = createPayloadClient();
      const existing = await client
      ...
      logger.error(
        `[TemporalWorker] deleteProductFromPayload failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async syncGovernanceToPayload(input: any) {
    logger.info(
      `[TemporalWorker] Executing syncGovernanceToPayload: tenant=${input.tenantId}`,
    );
    try {
      const client = createPayloadClient();
      const policyData = {
      ...
      if (existing) {
        await client.patch(
          `/api/governance-policies/${existing.id}`,
          policyData,
        );
      } else {
      ...
      logger.error(
        `[TemporalWorker] syncGovernanceToPayload failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async createERPNextInvoice(input: any) {
    logger.info(
      `[TemporalWorker] Executing createERPNextInvoice: order=${input.orderId}`,
    );
    try {
      ...
      logger.error(
        `[TemporalWorker] createERPNextInvoice failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async syncCustomerToERPNext(input: any) {
    logger.info(
      `[TemporalWorker] Executing syncCustomerToERPNext: ${input.customerId}`,
    );
    try {
      const service = createERPNextService();
      ...
      logger.error(
        `[TemporalWorker] syncCustomerToERPNext failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async syncProductToERPNext(input: any) {
    logger.info(
      `[TemporalWorker] Executing syncProductToERPNext: ${input.productId}`,
    );
    try {
      const service = createERPNextService();
      ...
      logger.error(
        `[TemporalWorker] syncProductToERPNext failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async syncVendorAsSupplier(input: any) {
    logger.info(
      `[TemporalWorker] Executing syncVendorAsSupplier: ${input.vendorId}`,
    );
    try {
      const service = createERPNextService();
      const result = await service.syncCustomer({
      ...
      logger.error(
        `[TemporalWorker] syncVendorAsSupplier failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async recordPaymentInERPNext(input: any) {
    logger.info(
      `[TemporalWorker] Executing recordPaymentInERPNext: order=${input.orderId}`,
    );
    try {
      const service = createERPNextService();
      const result = await service.recordPayment({
        ...
        received_amount:
          input.receivedAmount || input.paidAmount || input.amount || 0,
      ...
      logger.error(
        `[TemporalWorker] recordPaymentInERPNext failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async createFleetbaseShipment(input: any) {
    logger.info(
      `[TemporalWorker] Executing createFleetbaseShipment: order=${input.orderId}`,
    );
    try {
      ...
      logger.error(
        `[TemporalWorker] createFleetbaseShipment failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async syncPOIToFleetbase(input: any) {
    logger.info(
      `[TemporalWorker] Executing syncPOIToFleetbase: ${input.poiId}`,
    );
    try {
      const service = createFleetbaseService();
      ...
      logger.error(
        `[TemporalWorker] syncPOIToFleetbase failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async createDID(input: any) {
    ...
    try {
      ...
      logger.error(
        `[TemporalWorker] createDID failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async issueVendorCredential(input: any) {
    logger.info(
      `[TemporalWorker] Executing issueVendorCredential: ${input.vendorName}`,
    );
    try {
      const service = createWaltIdService();
      ...
      logger.error(
        `[TemporalWorker] issueVendorCredential failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async issueKYCCredential(input: any) {
    logger.info(
      `[TemporalWorker] Executing issueKYCCredential: ${input.customerName}`,
    );
    try {
      const service = createWaltIdService();
      ...
      logger.error(
        `[TemporalWorker] issueKYCCredential failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async issueMembershipCredential(input: any) {
    logger.info(
      `[TemporalWorker] Executing issueMembershipCredential: ${input.memberName}`,
    );
    try {
      const service = createWaltIdService();
      ...
      logger.error(
        `[TemporalWorker] issueMembershipCredential failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async syncNodeToAllSystems(input: any) {
    logger.info(
      `[TemporalWorker] Executing syncNodeToAllSystems: ${input.nodeId}`,
    );
  ...
  async deleteNodeFromAllSystems(input: any) {
    logger.info(
      `[TemporalWorker] Executing deleteNodeFromAllSystems: ${input.nodeId}`,
    );
    ...
    try {
      ...
      const existing = await payloadClient
        .get("/api/nodes", {
          params: {
            where: { medusaNodeId: { equals: input.nodeId } },
            limit: 1,
          },
        })
        .then((r) => r.data.docs?.[0])
  ...
  async scheduledProductSync(input: any) {
    logger.info(
      `[TemporalWorker] Executing scheduledProductSync: ${input.timestamp}`,
    );
    try {
      const payloadClient = createPayloadClient();
      const medusaUrl = appConfig.urls.backend;
      const productsResponse = await axios
        .get(`${medusaUrl}/store/products`, {
          params: { limit: 1000 },
        })
        .catch(() => ({ data: { products: [] } }));
      ...
      for (const product of products) {
        try {
          const existing = await payloadClient
            .get("/api/product-content", {
              params: {
                where: { medusaProductId: { equals: product.id } },
                limit: 1,
              },
            })
            .then((r) => r.data.docs?.[0])
          ...
          if (existing) {
            await payloadClient.patch(
              `/api/product-content/${existing.id}`,
              contentData,
            );
          } else {
      ...
      logger.error(
        `[TemporalWorker] scheduledProductSync failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async retryFailedSyncs(input: any) {
    logger.info(
      `[TemporalWorker] Executing retryFailedSyncs: ${input.timestamp}`,
    );
    try {
      const failedSyncs = await durableSyncTracker.getFailedSyncs(
        undefined,
        input.limit || 50,
      );
      let retried = 0;
      ...
      logger.error(
        `[TemporalWorker] retryFailedSyncs failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
  ...
  async hierarchyReconciliation(input: any) {
    logger.info(
      `[TemporalWorker] Executing hierarchyReconciliation: ${input.timestamp}`,
    );
    try {
      const payloadClient = createPayloadClient();
      const tenantsResponse = await payloadClient
        .get("/api/tenants", {
          params: { limit: 100 },
        })
        .catch(() => ({ data: { docs: [] } }));
      ...
      for (const tenant of tenants) {
        try {
          const nodesResponse = await payloadClient
            .get("/api/nodes", {
              params: {
                where: {
                  tenantId: { equals: tenant.medusaTenantId || tenant.id },
                },
                limit: 500,
              },
            })
      ...
      logger.error(
        `[TemporalWorker] hierarchyReconciliation failed: ${error instanceof Error ? error.message : String(error)}`,
      );
      throw error;
    }
  },
...
export async function startWorker(): Promise<void> {
  if (!appConfig.temporal.isConfigured) {
    logger.warn(
      "[TemporalWorker] TEMPORAL_API_KEY not set — skipping worker startup (graceful degradation)",
    );
    return;
  }
  ...
  if (!workerSDK) {
    logger.warn(
      "[TemporalWorker] @temporalio/worker not installed — skipping worker startup",
    );
    return;
  }
  ...
  if (!connectionSDK) {
    logger.warn(
      "[TemporalWorker] @temporalio/client not installed — skipping worker startup",
    );
    return;
  }

  const namespace = appConfig.temporal.namespace || "djvai.a2dd6";
  const endpoint = appConfig.temporal.address || appConfig.temporal.endpoint;
  const taskQueue = appConfig.temporal.taskQueue || "uce-commerce-financial";

  try {
    logger.info(
      `[TemporalWorker] Connecting to Temporal Cloud at ${endpoint}...`,
    );
    ...
    logger.info(
      `[TemporalWorker] Registering ${activityNames.length} activities: ${activityNames.join(", ")}`,
    );
    ...
    logger.info(
      `[TemporalWorker] Worker created and polling on task queue: ${taskQueue}`,
    );
    logger.info(
      `[TemporalWorker] Activity definitions registered: ${Object.keys(ACTIVITY_DEFINITIONS).length}`,
    );
    ...
    const shutdownHandler = async () => {
      ...
      isShuttingDown = true;
      logger.info(
        "[TemporalWorker] Received shutdown signal — draining worker...",
      );
      if (workerInstance) {
...
export function getWorkerStatus(): {
  ...
  return {
    ...
    taskQueue: appConfig.temporal.taskQueue || "uce-commerce-financial",
