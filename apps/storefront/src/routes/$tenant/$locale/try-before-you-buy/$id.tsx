    ...
    loader: async ({ params }) => {
      try {
        ...
        const resp = await fetchWithTimeout(
          `${baseUrl}/store/try-before-you-buy/${params.id}`,
          {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
            ...
            <p className="text-ds-muted-foreground mb-6">
              This try-before-you-buy product may have been removed or is no
              longer available.
            </p>
            <Link
              to={`${prefix}/try-before-you-buy` as never}
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {product.return_policy && (
              <div className="bg-ds-background border border-ds-border rounded-xl p-6">
                ...
                <p className="text-ds-muted-foreground text-sm leading-relaxed whitespace-pre-wrap">
                  {typeof product.return_policy === "string"
                    ? product.return_policy
                    : JSON.stringify(product.return_policy)}
                </p>
              </div>
            )}
            ...
            <div className="sticky top-4 space-y-6">
              <div className="bg-ds-background border border-ds-border rounded-xl p-6 space-y-4">
                <div className="text-center">
                  ...
                  {product.trial_period && (
                    <p className="text-sm text-ds-primary font-medium mt-1">
                      Try free for {product.trial_period}
                    </p>
                  )}
                </div>
              ...
              <div className="bg-ds-background border border-ds-border rounded-xl p-6">
                ...
                <ul className="space-y-3 text-sm text-ds-muted-foreground">
                  <li className="flex items-start gap-3">
                    <span className="w-6 h-6 bg-ds-primary/15 text-ds-primary rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">
                      1
                    </span>
              ...
              <div className="bg-ds-primary/10 border border-ds-primary/30 rounded-xl p-6">
                ...
                <p className="text-sm text-ds-primary">
                  No payment until you decide to keep the product. Free returns
