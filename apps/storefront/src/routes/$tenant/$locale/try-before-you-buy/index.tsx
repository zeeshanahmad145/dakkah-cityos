...
const fallbackItems = [
  {
    ...
    thumbnail: "/seed-images/try-before-you-buy/1504148455328-c376907d081c.jpg",
    description:
      "Experience world-class ANC with 30hr battery. Try them for 14 days risk-free.",
    trial_period: 14,
    deposit: 4999,
  },
  {
    ...
    category: "furniture",
    thumbnail: "/seed-images/try-before-you-buy/1504280390367-361c6d9f38f4.jpg",
    description:
      "Adjustable lumbar support, breathable mesh, and armrests. Perfect for home office.",
    trial_period: 30,
    deposit: 9999,
  },
  {
    ...
    category: "electronics",
    thumbnail: "/seed-images/try-before-you-buy/1516035069371-29a1b244cc32.jpg",
    description:
      "Track steps, heart rate, sleep, and workouts. Water-resistant to 50m.",
    trial_period: 14,
    deposit: 2499,
  },
  {
    ...
    category: "fashion",
    thumbnail: "/seed-images/try-before-you-buy/1504148455328-c376907d081c.jpg",
    description: "Polarized lenses, UV400 protection. Italian acetate frames.",
    trial_period: 7,
    deposit: 3499,
  },
  {
    ...
    thumbnail: "/seed-images/try-before-you-buy/1504280390367-361c6d9f38f4.jpg",
    description:
      "Dual boiler system with PID temperature control. Barista-grade at home.",
    trial_period: 30,
    deposit: 14999,
  },
  {
    ...
    thumbnail: "/seed-images/try-before-you-buy/1516035069371-29a1b244cc32.jpg",
    description:
      "5-piece premium skincare routine with cleanser, serum, moisturizer, eye cream & mask.",
    trial_period: 14,
    deposit: 4999,
  },
]
...
export const Route = createFileRoute("/$tenant/$locale/try-before-you-buy/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Try products before you buy on Dakkah CityOS",
      },
    ],
  }),
  loader: async () => {
    try {
      ...
      const resp = await fetchWithTimeout(
        `${baseUrl}/store/try-before-you-buy`,
        {
          headers: {
      ...
      <div className="bg-gradient-to-r from-ds-success to-ds-success text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            {t(locale, "try_before_you_buy.title")}
          </h1>
          ...
          <div className="mt-6 flex items-center justify-center gap-4 text-sm text-white/60">
            ...
            <span>|</span>
            <span>
              {t(locale, "tryBeforeYouBuy.badge_risk_free", "Risk-free trials")}
            </span>
            <span>|</span>
            <span>
              {t(locale, "tryBeforeYouBuy.badge_free_returns", "Free returns")}
            </span>
          </div>
        </div>
      </div>
            ...
            <div className="bg-ds-background border border-ds-border rounded-xl p-4 space-y-6 sticky top-4">
              <div>
                ...
                <input
                  ...
                  placeholder={t(
                    locale,
                    "try_before_you_buy.search_placeholder",
                  )}
            ...
            {filteredItems.length === 0 ? (
              <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
                ...
                <h3 className="text-lg font-semibold text-ds-foreground mb-2">
                  {t(locale, "try_before_you_buy.no_results")}
                </h3>
                    ...
                    <div className="aspect-[4/3] bg-gradient-to-br from-ds-success/10 to-ds-success/10 relative overflow-hidden">
                      {item.thumbnail ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          <svg
                            className="w-16 h-16 text-ds-success/40"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                          >
                      ...
                      <span className="absolute top-2 start-2 px-2.5 py-1 text-xs font-bold bg-ds-success text-white rounded-md">
                        Try Free
                      </span>
                      {item.trial_period && (
                        <span className="absolute top-2 end-2 px-2 py-1 text-xs font-medium bg-black/70 text-white rounded-md">
                          {item.trial_period}-day trial
                        </span>
                      )}
                    </div>
                    <div className="p-4">
                      ...
                      {item.category && (
                        <span className="inline-block mt-2 px-2 py-0.5 text-xs font-medium bg-ds-success/10 text-ds-success rounded capitalize">
                          {item.category}
                        </span>
                      )}
                      ...
                      <div className="flex justify-between items-center pt-3 mt-3 border-t border-ds-border">
                        ...
                        <span className="px-4 py-1.5 text-xs font-semibold text-white bg-ds-success rounded-lg group-hover:bg-ds-success/90 transition-colors">
                          {t(locale, "try_before_you_buy.try_now")}
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Select a product and start your free trial with a refundable
                deposit.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Use the product during the trial period. No commitment.
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-ds-success text-white flex items-center justify-center text-xl font-bold mx-auto mb-4">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Love it? Keep it. Not for you? Return it for free and get your
                deposit back.
              </p>
            </div>
          </div>
