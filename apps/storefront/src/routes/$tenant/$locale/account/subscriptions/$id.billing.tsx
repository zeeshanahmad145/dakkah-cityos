...
export const Route = createFileRoute(
  ...
  loader: async ({ params }) => {
    try {
      ...
      return { item: ((data as any)?.subscription ?? data) || data }
    } catch {
      return { item: null }
    }
  },
    ...
    return (
      <AccountLayout>
        <div className="text-center py-12">
          ...
          <Link
            to={`/${tenant}/${locale}/account/subscriptions` as never}
  ...
  return (
    <AccountLayout>
      <div className="max-w-2xl">
        {/* Back Link */}
        <Link
          to={`/${tenant}/${locale}/account/subscriptions/${id}` as never}
        ...
        <div className="space-y-6">
          {paymentMethod ? (
            ...
            <div className="bg-ds-background rounded-xl border border-ds-border p-6">
              ...
              <p className="text-ds-muted-foreground text-sm mb-4">
