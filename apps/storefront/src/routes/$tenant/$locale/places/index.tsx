...
export const Route = createFileRoute("/$tenant/$locale/places/")({
  ...
  loader: async () => {
    try {
      const places = [
        { id: "1", name: "Grand Mosque (Masjid al-Haram)", description: "The largest mosque in the world, surrounding Islam's holiest place, the Kaaba in Mecca.", category: "Religious", rating: 4.9, reviews: 12500, location: "Mecca, Saudi Arabia", image: "/seed-images/content%2F1586724237569-f3d0c1dee8c6.jpg" },
        { id: "2", name: "Souq Al-Zal", description: "Historic marketplace in Riyadh known for traditional crafts, antiques, and authentic Arabian goods.", category: "Shopping", rating: 4.5, reviews: 3200, location: "Riyadh, Saudi Arabia", image: "/seed-images/content%2F1548013146-72479768bada.jpg" },
        { id: "3", name: "Kingdom Tower", description: "Iconic 99-floor skyscraper with a sky bridge offering panoramic views of Riyadh's skyline.", category: "Landmark", rating: 4.7, reviews: 8900, location: "Riyadh, Saudi Arabia", image: "/seed-images/content%2F1573164713988-8665fc963095.jpg" },
        { id: "4", name: "Al Masmak Fort", description: "Historic clay and mud-brick fortress that played a key role in the founding of Saudi Arabia.", category: "Historical", rating: 4.6, reviews: 5600, location: "Riyadh, Saudi Arabia", image: "/seed-images/content%2F1558171813-4c088753af8f.jpg" },
        { id: "5", name: "Edge of the World", description: "Dramatic cliff formation northwest of Riyadh offering breathtaking views of the endless desert.", category: "Nature", rating: 4.8, reviews: 4200, location: "Riyadh Province, Saudi Arabia", image: "/seed-images/content%2F1682687220742-aba13b6e50ba.jpg" },
        { id: "6", name: "Al-Ula Heritage Village", description: "Ancient village with remarkable rock formations and the UNESCO World Heritage site of Hegra.", category: "Heritage", rating: 4.9, reviews: 6700, location: "Al-Ula, Saudi Arabia", image: "/seed-images/content%2F1519167758481-83f550bb49b3.jpg" },
        { id: "7", name: "Jeddah Corniche", description: "Beautiful waterfront promenade stretching along the Red Sea with parks, sculptures, and dining.", category: "Leisure", rating: 4.4, reviews: 7800, location: "Jeddah, Saudi Arabia", image: "/seed-images/content%2F1578662996442-48f60103fc96.jpg" },
        { id: "8", name: "Diriyah", description: "Historic seat of the first Saudi state, now a cultural destination with museums and restaurants.", category: "Heritage", rating: 4.7, reviews: 4500, location: "Riyadh, Saudi Arabia", image: "/seed-images/content%2F1454165804606-c3d57bc86b40.jpg" },
      ]
      return { places }
    } catch {
      return { places: [] }
