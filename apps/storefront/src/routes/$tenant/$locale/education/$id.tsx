  ...
  loader: async ({ params }) => {
    try {
      ...
      const resp = await fetchWithTimeout(
        `${baseUrl}/store/education/${params.id}`,
        {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
            ...
            <p className="text-ds-muted-foreground mb-6">
              This course or program may have been removed or is no longer
              available.
            </p>
            <Link
              to={`${prefix}/education` as never}
            ...
            {(course.curriculum || course.syllabus) && (
              <div className="bg-ds-background border border-ds-border rounded-xl p-6">
                ...
                <div className="space-y-3">
                  {(course.curriculum || course.syllabus).map(
            ...
            <div className="sticky top-4 space-y-6">
              <div className="bg-ds-background border border-ds-border rounded-xl p-6 space-y-4">
                ...
                <button
                  ...
                  className="w-full py-3 px-4 bg-ds-primary text-ds-primary-foreground rounded-lg font-medium hover:bg-ds-primary/90 transition-colors disabled:opacity-50"
                >
                  ...
                  {course.certificate && (
                    <div className="flex items-center gap-2 text-ds-muted-foreground">
                      ...
                      <span>
                        {t(
                          locale,
                          "education.certificate_of_completion",
                ...
                <div className="bg-ds-background border border-ds-border rounded-xl p-6">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-12 h-12 bg-ds-primary/10 rounded-full flex items-center justify-center text-ds-primary font-semibold">
                      {(course.instructor_info.name || course.instructor || "I")
                        .charAt(0)
                        .toUpperCase()}
                    </div>
                    <div>
