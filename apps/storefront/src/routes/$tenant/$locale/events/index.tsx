...
export const Route = createFileRoute("/$tenant/$locale/events/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Browse upcoming events on Dakkah CityOS",
      },
    ],
  }),
  loader: async () => {
    try {
      ...
      const raw =
        data.items || data.events || data.listings || data.products || []
      const items = raw.map((s: any) => {
        ...
        return {
          ...
          starts_at:
            ...
            null,
          ends_at:
            s.ends_at || s.end_date || meta.ends_at || meta.end_date || null,
      ...
      <div className="bg-gradient-to-r from-ds-success to-ds-info text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            {t(locale, "events.hero_title")}
          </h1>
          <p className="text-lg text-white/80 max-w-2xl mx-auto">
            Discover concerts, festivals, conferences, workshops, and
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <aside className="w-full lg:w-72 flex-shrink-0">
            <div className="bg-ds-background border border-ds-border rounded-xl p-4 space-y-6 sticky top-4">
              ...
              <div>
                <label className="block text-sm font-medium text-ds-foreground mb-2">
                  {t(locale, "verticals.event_type_label")}
                </label>
                    ...
                    <div className="aspect-[4/3] bg-gradient-to-br from-ds-success/10 to-ds-info/15 relative overflow-hidden">
                      ...
                      {item.starts_at && (
                        <div className="absolute bottom-2 start-2 bg-ds-card/95 rounded-lg px-2 py-1 text-center shadow-sm">
                          <div className="text-xs font-bold text-ds-success uppercase">
                            {new Date(item.starts_at!).toLocaleDateString(
                              "en-US",
                              { month: "short" },
                            )}
                          </div>
                          <div className="text-lg font-bold text-ds-foreground leading-tight">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Browse events by type, date, or location to find experiences
                that excite you.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Select your seats, choose ticket types, and complete your
                purchase securely.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Receive your digital tickets and enjoy an unforgettable
                experience.
              </p>
            </div>
          </div>
