...
function TravelPage() {
  ...
  const filteredItems = items.filter((item: any) => {
    ...
    const matchesStar =
      starFilter === "all" || String(item.star_rating) === starFilter
      ...
      <div className="bg-gradient-to-r from-ds-info/100 to-ds-primary text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            {t(locale, "travel.title")}
          </h1>
          <p className="text-lg text-white/80 max-w-2xl mx-auto">
            Book hotels, resorts, apartments, and unique stays for your next
            adventure.
          </p>
                      ...
                      {opt === "all" ? (
                        ...
                        <span className="flex items-center gap-1">
                          {Array.from({ length: Number(opt) }, (_, i) => (
                            <svg
                              key={i}
                              className="w-3.5 h-3.5 text-ds-warning"
                              fill="currentColor"
                              viewBox="0 0 20 20"
                            >
                  ...
                  >
                    <div className="aspect-[4/3] bg-gradient-to-br from-ds-info/10 to-ds-primary/15 relative overflow-hidden">
                      {item.thumbnail ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          <svg
                            className="w-16 h-16 text-ds-info/40"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke="currentColor"
                          >
                      ...
                      {item.star_rating && (
                        <div className="absolute top-2 end-2 px-2 py-1 text-xs font-medium bg-ds-card/90 text-ds-foreground/80 rounded-md flex items-center gap-0.5">
                          {Array.from({ length: item.star_rating }, (_, i) => (
                            <svg
                              key={i}
                              className="w-3 h-3 text-ds-warning"
                              fill="currentColor"
                              viewBox="0 0 20 20"
                            >
                              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    ...
                    <div className="p-4">
                          ...
                          <div className="flex flex-wrap gap-1 mt-2">
                            {item.amenities
                              ...
                              .map((a: string, i: number) => (
                                <span
                                  key={i}
                                  className="px-2 py-0.5 text-xs rounded-full bg-ds-info/10 text-ds-info border border-ds-info/30"
                                >
                                  {a}
                                </span>
                              ))}
                      ...
                      <div className="flex justify-between items-center pt-3 mt-3 border-t border-ds-border">
                        ...
                        <span className="px-3 py-1.5 text-xs font-semibold text-white bg-ds-info rounded-lg group-hover:bg-ds-info transition-colors">
                          {t(locale, "travel.book_now")}
                        </span>
                      </div>
                    </div>
                  </a>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Browse hotels, resorts, and stays by location, type, or star
                rating.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Compare amenities, reviews, and prices to find your perfect
                stay.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Receive your booking confirmation and enjoy a wonderful
                experience.
              </p>
            </div>
          </div>
