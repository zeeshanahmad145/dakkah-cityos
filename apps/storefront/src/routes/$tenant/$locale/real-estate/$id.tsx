  ...
  loader: async ({ params }) => {
    try {
      ...
      const resp = await fetchWithTimeout(
        `${baseUrl}/store/real-estate/${params.id}`,
        {
...
function RealEstateDetailPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
            ...
            <p className="text-ds-muted-foreground mb-6">
              This property listing may have been removed or is no longer
              available.
            </p>
            <Link
              to={`${prefix}/real-estate` as never}
  ...
  const highlights = [
    {
      label: t(locale, "realestate.label_bedrooms", "Bedrooms"),
      value: property.bedrooms,
      icon: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6",
    },
    {
      label: t(locale, "realestate.label_bathrooms", "Bathrooms"),
      value: property.bathrooms,
      icon: "M4 6h16M4 10h16M4 14h16M4 18h16",
    },
    {
      label: t(locale, "realestate.label_sq_ft", "Sq Ft"),
      value: property.sqft
        ? Number(property.sqft || 0).toLocaleString()
        : property.square_feet
          ? Number(property.square_feet || 0).toLocaleString()
          : null,
      icon: "M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4",
    },
    {
      label: t(locale, "realestate.label_type", "Type"),
      value: property.property_type || property.propertyType,
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-ds-primary mt-3">
                ...
                {property.listing_type === "rent" && (
                  <span className="text-base font-normal text-ds-muted-foreground">
                    /mo
                  </span>
                )}
              </p>
            ...
            {highlights.length > 0 && (
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {highlights.map((h) => (
                  <div
                    key={h.label}
                    className="bg-ds-background border border-ds-border rounded-xl p-4 text-center"
                  >
                    <svg
                      className="w-6 h-6 text-ds-primary mx-auto mb-2"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
            ...
            <div className="sticky top-4 space-y-6">
              ...
              <div className="bg-ds-background border border-ds-border rounded-xl p-6">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {property.lot_size && (
                    <div className="flex justify-between">
                      <span className="text-ds-muted-foreground">Lot Size</span>
                      <span className="text-ds-foreground font-medium">
                        {property.lot_size}
                      </span>
                    </div>
                  ...
                  {property.parking && (
                    <div className="flex justify-between">
                      <span className="text-ds-muted-foreground">Parking</span>
                      <span className="text-ds-foreground font-medium">
                        {property.parking}
                      </span>
                    </div>
                  ...
                  {property.hoa_fee && (
                    <div className="flex justify-between">
                      <span className="text-ds-muted-foreground">HOA Fee</span>
                      <span className="text-ds-foreground font-medium">
                        ${property.hoa_fee}/mo
                      </span>
                    </div>
