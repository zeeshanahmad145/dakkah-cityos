  ...
  const filteredItems = items.filter((item: any) => {
    ...
    const matchesCategory =
      ...
      (item.categories || []).some(
        (c: string) => c.toLowerCase() === categoryFilter,
      )
      ...
      <div className="bg-gradient-to-r from-ds-primary to-ds-primary/90 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/80 max-w-2xl mx-auto">
            Discover trusted sellers and explore their unique products and
            services.
          </p>
          <div className="mt-6 flex items-center justify-center gap-4 text-sm text-white/60">
            ...
            <span>|</span>
            <span>
              {t(locale, "vendors.badge_verified_sellers", "Verified sellers")}
            </span>
            <span>|</span>
            <span>
              {t(
                locale,
                "vendors.badge_quality_guaranteed",
                "Quality guaranteed",
              )}
            </span>
          </div>
              ...
              <div>
                ...
                <div className="space-y-1">
                  {verifiedOptions.map((opt) => (
                    ...
                    >
                      {opt === "all"
                        ? t(locale, "verticals.all_vendors")
                        : opt.charAt(0).toUpperCase() + opt.slice(1)}
                    </button>
                  ))}
                </div>
                        ...
                        <div className="flex flex-wrap gap-1 mt-3">
                          {item.categories
                            ...
                            .map((cat: string, i: number) => (
                              <span
                                key={i}
                                className="px-2 py-0.5 text-xs bg-ds-primary/10 text-ds-primary rounded-full capitalize"
                              >
                                {cat}
                              </span>
                            ))}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Every vendor is vetted for quality and reliability.
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-ds-primary text-white flex items-center justify-center text-xl font-bold mx-auto mb-4">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Transparent ratings and reviews from real customers.
              </p>
            </div>
          </div>
        </div>
