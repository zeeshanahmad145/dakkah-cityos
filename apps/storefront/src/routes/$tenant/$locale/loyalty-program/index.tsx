...
const fallbackItems = [
  {
    ...
    name: "Bronze",
    color: "ds-warning",
    bg: "from-ds-warning to-ds-warning/90",
    points_required: 0,
    badge_emoji: "🥉",
    perks: [
      "loyalty.perk_bronze_1",
      "loyalty.perk_bronze_2",
      "loyalty.perk_bronze_3",
      "loyalty.perk_bronze_4",
    ],
    description:
      "Start earning rewards from your very first purchase. Every dollar spent earns you 1 point.",
  },
  {
    id: "tier-2",
    name: "Silver",
    color: "ds-muted-foreground",
    bg: "from-ds-muted-foreground to-ds-muted-foreground/80",
    points_required: 500,
    badge_emoji: "🥈",
    perks: [
      "loyalty.perk_silver_1",
      "loyalty.perk_silver_2",
      "loyalty.perk_silver_3",
      "loyalty.perk_silver_4",
      "loyalty.perk_silver_5",
      "loyalty.perk_silver_6",
    ],
    description:
      "Reach Silver status with 500 points and unlock premium shopping benefits.",
  },
  {
    id: "tier-3",
    name: "Gold",
    color: "yellow-500",
    bg: "from-ds-warning to-ds-warning",
    ...
    description:
      "Gold members enjoy the best perks with 2,000 points. Shop more, save more.",
  },
  {
    id: "tier-4",
    name: "Platinum",
    color: "ds-muted-foreground",
    bg: "from-ds-muted-foreground to-ds-primary",
    points_required: 5000,
    badge_emoji: "💎",
    perks: [
      "loyalty.perk_platinum_1",
      "loyalty.perk_platinum_2",
      "loyalty.perk_platinum_3",
      "loyalty.perk_platinum_4",
      "loyalty.perk_platinum_5",
      "loyalty.perk_platinum_6",
      "loyalty.perk_platinum_7",
      "loyalty.perk_platinum_8",
      "loyalty.perk_platinum_9",
      "loyalty.perk_platinum_10",
    ],
    description:
      "The ultimate tier. Platinum members with 5,000+ points enjoy unmatched luxury benefits.",
  },
]
...
export const Route = createFileRoute("/$tenant/$locale/loyalty-program/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Join the loyalty program on Dakkah CityOS",
      },
    ],
  }),
  loader: async () => {
      ...
      <div className="bg-gradient-to-r from-ds-warning to-ds-warning text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-6 flex items-center justify-center gap-4 text-sm text-white/60">
            ...
            <span>|</span>
            <span>
              {t(locale, "loyalty.badge_earn_points", "Earn 1 point per $1")}
            </span>
            <span>|</span>
            <span>
              {t(locale, "loyalty.badge_up_to_discount", "Up to 20% off")}
            </span>
          </div>
        </div>
      </div>
        ...
        {items.length === 0 ? (
          <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
            <h3 className="text-lg font-semibold text-ds-foreground mb-2">
              {t(locale, "loyaltyProgram.no_results")}
            </h3>
            <p className="text-ds-muted-foreground text-sm">
              Check back later for our loyalty program details.
            </p>
          </div>
        ) : (
            ...
            {items.map((tier: any, index: number) => (
              ...
              >
                <div className="flex flex-col md:flex-row">
                  <div
                    className={`bg-gradient-to-br ${tier.bg || "from-ds-warning to-ds-warning"} p-8 md:w-72 flex flex-col items-center justify-center text-white`}
                  >
                    ...
                    <div className="mb-4">
                      ...
                      <div className="grid sm:grid-cols-2 gap-2">
                        {(tier.perks || []).map((perk: string, idx: number) => (
                          ...
                          >
                            <svg
                              className="w-4 h-4 text-ds-warning mt-0.5 flex-shrink-0"
                              fill="none"
                              viewBox="0 0 24 24"
                              stroke="currentColor"
                            >
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Create an account and automatically start earning points.
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-ds-warning text-white flex items-center justify-center text-xl font-bold mx-auto mb-4">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Get 1 point for every $1 spent. Bonus points on special days.
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-ds-warning text-white flex items-center justify-center text-xl font-bold mx-auto mb-4">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Rise through tiers and enjoy increasing benefits and discounts.
              </p>
            </div>
          </div>
        </div>
