  ...
  return [
    {
      ...
      category: "concerts",
      description:
        "A weekend of live music featuring top international artists. Enjoy performances from Grammy-winning artists, emerging talents, and local bands across multiple stages. Food trucks, art installations, and VIP lounges available.",
      tickets_available: 250,
      time: "7:00 PM",
      ticket_types: [
        { name: "General Admission", price: 8999 },
        { name: "VIP", price: 19999 },
        { name: "Backstage Pass", price: 34999 },
      ],
    },
    {
      id: "et-2",
      ...
      category: "sports",
      description:
        "Watch the Champions League final on the big screen with fellow fans. Giant LED screens, surround sound, food and drinks available.",
      tickets_available: 500,
      time: "8:00 PM",
      ticket_types: [
        { name: "Standard", price: 4999 },
        { name: "Premium Seating", price: 9999 },
      ],
    },
    {
      id: "et-3",
      ...
      time: "6:30 PM",
      ticket_types: [
        { name: "Lawn Seating", price: 5999 },
        { name: "Reserved Seating", price: 8999 },
      ],
    },
    {
      id: "et-4",
      ...
      category: "comedy",
      description:
        "An evening of laughs with top comedians from around the world. Two-drink minimum included with every ticket.",
      tickets_available: 80,
      time: "9:00 PM",
      ticket_types: [
        { name: "General", price: 3499 },
        { name: "Front Row", price: 6999 },
      ],
    },
    {
      id: "et-5",
      ...
      description:
        "Three days of keynotes, workshops, and networking with industry leaders in AI, blockchain, and cloud computing.",
      tickets_available: 1000,
      time: "9:00 AM",
      ticket_types: [
        { name: "Day Pass", price: 19999 },
        { name: "Full Conference", price: 49999 },
        { name: "VIP All-Access", price: 79999 },
      ],
    },
    {
      id: "et-6",
      ...
      category: "festivals",
      description:
        "Sample cuisines from 50+ local restaurants and wineries. Live cooking demos, sommelier sessions, and family-friendly activities.",
      tickets_available: 350,
      time: "12:00 PM",
      ticket_types: [
        { name: "Tasting Pass", price: 7499 },
        { name: "Premium Tasting", price: 14999 },
      ],
    },
  ]
}
  ...
  loader: async ({ params }) => {
    try {
      ...
      const resp = await fetchWithTimeout(
        `${baseUrl}/store/event-ticketing/${params.id}`,
        {
      ...
      if (!resp.ok) {
        const fallback =
          getFallbackItems().find((i) => i.id === params.id) || null
      ...
      <div className="min-h-screen bg-ds-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
            ...
            <Link
              to={`${prefix}/event-ticketing` as never}
              ...
              <div className="bg-ds-background border border-ds-border rounded-xl p-6 space-y-4">
                <div className="text-center">
                  <p className="text-3xl font-bold text-ds-primary">
                    {formatPrice(
                      ticketTypes[selectedTicketType]?.price ||
                        event.price ||
                        0,
                    )}
                  </p>
                ...
                <div>
                  ...
                  <div className="flex items-center border border-ds-border rounded-lg">
                    <button
                      ...
                      className="px-3 py-2 text-ds-foreground hover:bg-ds-muted transition-colors rounded-l-lg"
                    >
                      -
                    </button>
                    <span className="flex-1 text-center text-sm font-medium text-ds-foreground">
                      {quantity}
                    </span>
                    <button
                      onClick={() => setQuantity(Math.min(10, quantity + 1))}
                      className="px-3 py-2 text-ds-foreground hover:bg-ds-muted transition-colors rounded-r-lg"
                    >
                      +
                    </button>
                  </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {getFallbackItems()
              ...
              .map((item) => (
                <Link
                  key={item.id}
                  to={`${prefix}/event-ticketing/${item.id}` as never}
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <p className="text-lg font-bold text-ds-primary mt-2">
