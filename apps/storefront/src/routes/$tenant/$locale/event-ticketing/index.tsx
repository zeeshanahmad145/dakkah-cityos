...
function getFallbackItems() {
  return [
    { id: "et-1", name: "Summer Music Festival 2026", venue: "Central Park Arena", date: "2026-07-15T19:00:00Z", thumbnail: "/seed-images/events%2F1459749411175-04bf5292ceea.jpg", price: 8999, category: "concerts", description: "A weekend of live music featuring top international artists", tickets_available: 250 },
    { id: "et-2", name: "Champions League Final Screening", venue: "City Sports Complex", date: "2026-05-30T20:00:00Z", thumbnail: "/seed-images/event-ticketing%2F1488646953014-85cb44e25828.jpg", price: 4999, category: "sports", description: "Watch the Champions League final on the big screen with fellow fans", tickets_available: 500 },
    { id: "et-3", name: "Shakespeare in the Park", venue: "Riverside Theater", date: "2026-08-10T18:30:00Z", thumbnail: "/seed-images/events%2F1505373877841-8d25f7d46678.jpg", price: 5999, category: "theater", description: "A modern rendition of A Midsummer Night's Dream under the stars", tickets_available: 120 },
    { id: "et-4", name: "Stand-Up Comedy Night", venue: "The Laugh Factory", date: "2026-04-20T21:00:00Z", thumbnail: "/seed-images/events%2F1514525253161-7a46d19cd819.jpg", price: 3499, category: "comedy", description: "An evening of laughs with top comedians from around the world", tickets_available: 80 },
    { id: "et-5", name: "Tech Innovation Summit 2026", venue: "Convention Center Hall A", date: "2026-09-05T09:00:00Z", thumbnail: "/seed-images/events%2F1540575467063-178a50c2df87.jpg", price: 19999, category: "conferences", description: "Three days of keynotes, workshops, and networking with industry leaders", tickets_available: 1000 },
    { id: "et-6", name: "Food & Wine Festival", venue: "Harbor Pavilion", date: "2026-06-22T12:00:00Z", thumbnail: "/seed-images/events%2F1555939594-58d7cb561ad1.jpg", price: 7499, category: "festivals", description: "Sample cuisines from 50+ local restaurants and wineries", tickets_available: 350 },
    { id: "et-7", name: "Jazz Under the Stars", venue: "Rooftop Lounge", date: "2026-05-15T20:00:00Z", thumbnail: "/seed-images/events%2F1568605117036-5fe5e7bab0b7.jpg", price: 6499, category: "concerts", description: "An intimate evening of live jazz performances with city skyline views", tickets_available: 60 },
    { id: "et-8", name: "Marathon City Run 2026", venue: "Downtown Circuit", date: "2026-10-12T06:00:00Z", thumbnail: "/seed-images/event-ticketing%2F1507525428034-b723cf961d3e.jpg", price: 2999, category: "sports", description: "Join thousands of runners in the annual city marathon", tickets_available: 5000 },
  ]
}
