  ...
  return [
    {
      ...
      category: "concerts",
      description:
        "A weekend of live music featuring top international artists",
    ...
    },
    {
      ...
      category: "sports",
      description:
        "Watch the Champions League final on the big screen with fellow fans",
    ...
    },
    {
      ...
      category: "theater",
      description:
        "A modern rendition of A Midsummer Night's Dream under the stars",
    ...
    },
    {
      ...
      category: "comedy",
      description:
        "An evening of laughs with top comedians from around the world",
    ...
    },
    {
      ...
      description:
        "Three days of keynotes, workshops, and networking with industry leaders",
    ...
    },
    {
      ...
      price: 7499,
      category: "festivals",
      description: "Sample cuisines from 50+ local restaurants and wineries",
    ...
    },
    {
      ...
      category: "concerts",
      description:
        "An intimate evening of live jazz performances with city skyline views",
      tickets_available: 60,
    },
    {
      id: "et-8",
      name: "Marathon City Run 2026",
      ...
      <div className="bg-gradient-to-r from-ds-primary to-ds-info text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/80 max-w-2xl mx-auto">
            Discover and book tickets for concerts, sports, theater, conferences
            and more
          </p>
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <div className="flex justify-between items-center pt-3 mt-3 border-t border-ds-border">
                          <span className="text-xl font-bold text-ds-primary">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Explore upcoming events across concerts, sports, theater and
                more
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Choose your seats and ticket type with transparent pricing
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-ds-primary text-white flex items-center justify-center text-xl font-bold mx-auto mb-4">
