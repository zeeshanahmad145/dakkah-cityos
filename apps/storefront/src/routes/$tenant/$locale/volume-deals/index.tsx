...
const fallbackItems = [
  { id: "vd-1", name: "Premium Ballpoint Pens", category: "office", thumbnail: "/seed-images/volume-deals/1486406146926-c627a92ad1ab.jpg", description: "Smooth-writing metal ballpoint pens with ergonomic grip. Blue ink. Ideal for corporate gifts.", tiers: [{ qty: "10+", price: 499 }, { qty: "50+", price: 399 }, { qty: "100+", price: 299 }], max_savings: 40 },
  { id: "vd-2", name: "Reusable Shopping Bags", category: "retail", thumbnail: "/seed-images/volume-deals/1497435334941-8c899ee9e8e9.jpg", description: "Eco-friendly non-woven bags, full-color printing available. Perfect for retail promotions.", tiers: [{ qty: "10+", price: 350 }, { qty: "50+", price: 250 }, { qty: "100+", price: 150 }], max_savings: 57 },
  { id: "vd-3", name: "USB Flash Drives 32GB", category: "electronics", thumbnail: "/seed-images/volume-deals/1504674900247-0877df9cc836.jpg", description: "Compact USB 3.0 flash drives with custom logo area. Bulk pricing for events.", tiers: [{ qty: "10+", price: 899 }, { qty: "50+", price: 699 }, { qty: "100+", price: 499 }], max_savings: 45 },
  { id: "vd-4", name: "Cotton Face Towels", category: "hospitality", thumbnail: "/seed-images/volume-deals/1486406146926-c627a92ad1ab.jpg", description: "500 GSM premium cotton towels. Machine washable, quick-drying. Hotel & spa grade.", tiers: [{ qty: "10+", price: 699 }, { qty: "50+", price: 549 }, { qty: "100+", price: 399 }], max_savings: 43 },
  { id: "vd-5", name: "Corrugated Shipping Boxes", category: "packaging", thumbnail: "/seed-images/volume-deals/1497435334941-8c899ee9e8e9.jpg", description: "Heavy-duty double-wall corrugated boxes. Standard sizes available. Custom sizes on request.", tiers: [{ qty: "10+", price: 299 }, { qty: "50+", price: 199 }, { qty: "100+", price: 129 }], max_savings: 57 },
  { id: "vd-6", name: "Hand Sanitizer Bottles 250ml", category: "hygiene", thumbnail: "/seed-images/volume-deals/1504674900247-0877df9cc836.jpg", description: "70% alcohol gel sanitizer. FDA-approved. Private label available.", tiers: [{ qty: "10+", price: 499 }, { qty: "50+", price: 349 }, { qty: "100+", price: 249 }], max_savings: 50 },
]
