  ...
  loader: async ({ params }) => {
    try {
      ...
      const resp = await fetchWithTimeout(
        `${baseUrl}/store/dropshipping/${params.id}`,
        {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
            ...
            <p className="text-ds-muted-foreground mb-6">
              This supplier may no longer be available on the platform.
            </p>
            <Link
              to={`${prefix}/dropshipping` as never}
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex items-start gap-4">
              <div className="w-16 h-16 bg-ds-primary/10 rounded-xl flex items-center justify-center text-ds-primary text-2xl font-bold flex-shrink-0">
                {(supplier.name || supplier.title || "S")
                  .charAt(0)
                  .toUpperCase()}
              </div>
              <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {supplier.shipping_time && (
                  <div className="flex items-start gap-3">
                    <svg
                      className="w-5 h-5 text-ds-primary mt-0.5 flex-shrink-0"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {(supplier.products ?? []).map((product: any) => (
                    ...
                    >
                      ...
                      {product.price && (
                        <p className="text-sm text-ds-primary font-semibold mt-1">
            ...
            <div className="sticky top-4 space-y-6">
              <div className="bg-ds-background border border-ds-border rounded-xl p-6 space-y-4">
                ...
                <button
                  ...
                  className="w-full py-2.5 px-4 rounded-lg font-medium text-sm border border-ds-border text-ds-foreground hover:bg-ds-muted transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
