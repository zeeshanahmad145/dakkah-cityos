  ...
  loader: async ({ params }) => {
    try {
      ...
      const resp = await fetchWithTimeout(
        `${baseUrl}/store/print-on-demand/${params.id}`,
        {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
            ...
            <p className="text-ds-muted-foreground mb-6">
              This print-on-demand product may have been discontinued or is no
              longer available.
            </p>
            <Link
              to={`${prefix}/print-on-demand` as never}
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="relative aspect-[4/3] bg-ds-muted rounded-xl overflow-hidden">
              {product.thumbnail || product.image || product.mockup_url ? (
                <img
                  loading="lazy"
                  src={product.thumbnail || product.image || product.mockup_url}
