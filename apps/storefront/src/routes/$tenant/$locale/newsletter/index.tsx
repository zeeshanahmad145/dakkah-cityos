...
const fallbackItems = [
  { id: "nl-1", name: "Tech Trends Weekly", topic: "technology", thumbnail: "/seed-images/newsletters/1518770660439-4636190af475.jpg", edition_date: "2026-02-10", topics_covered: ["AI & Machine Learning", "Web3 Updates", "Cloud Computing"], description: "Stay ahead with the latest technology trends, product launches, and industry insights." },
  { id: "nl-2", name: "Style & Living", topic: "lifestyle", thumbnail: "/seed-images/newsletters/1489987707025-afc232f7ea0f.jpg", edition_date: "2026-02-08", topics_covered: ["Fashion Tips", "Interior Design", "Wellness"], description: "Your weekly guide to fashion, home design, and modern living." },
  { id: "nl-3", name: "Business Insider Report", topic: "business", thumbnail: "/seed-images/newsletters/1441974231531-c6227db76b6e.jpg", edition_date: "2026-02-12", topics_covered: ["Market Analysis", "Startup News", "Investment Tips"], description: "Comprehensive business intelligence and market analysis for professionals." },
  { id: "nl-4", name: "Green Planet Digest", topic: "sustainability", thumbnail: "/seed-images/newsletters/1441974231531-c6227db76b6e.jpg", edition_date: "2026-02-05", topics_covered: ["Climate Action", "Sustainable Products", "Eco-Innovations"], description: "Environmental news, sustainable living tips, and eco-friendly product reviews." },
  { id: "nl-5", name: "Health & Wellness Focus", topic: "health", thumbnail: "/seed-images/newsletters/1489987707025-afc232f7ea0f.jpg", edition_date: "2026-02-11", topics_covered: ["Nutrition Guide", "Fitness Plans", "Mental Health"], description: "Expert-backed health advice, workout routines, and nutrition guides." },
  { id: "nl-6", name: "The Deal Hunter", topic: "shopping", thumbnail: "/seed-images/newsletters/1518770660439-4636190af475.jpg", edition_date: "2026-02-13", topics_covered: ["Best Deals", "Coupon Codes", "Product Reviews"], description: "Never miss a great deal — curated savings and product recommendations." },
]
