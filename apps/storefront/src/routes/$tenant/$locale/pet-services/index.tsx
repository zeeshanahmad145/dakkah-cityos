        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="flex items-center justify-center gap-2 text-sm text-white/70 mb-4">
            ...
            <span className="text-white">
              {t(locale, "petService.breadcrumb")}
            </span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            {t(locale, "petService.hero_title")}
          </h1>
          ...
          <div className="mt-6 flex items-center justify-center gap-4 text-sm text-white/60">
            <span>
              {items.length} {t(locale, "petService.pets_count")}
            </span>
            <span>|</span>
            ...
            <div className="bg-ds-background border border-ds-border rounded-xl p-4 space-y-6 sticky top-4">
              <div>
                <label className="block text-sm font-medium text-ds-foreground mb-2">
                  {t(locale, "petService.search_label")}
                </label>
                <input
                  type="text"
                  value={searchQuery}
              ...
              <div>
                <label className="block text-sm font-medium text-ds-foreground mb-2">
                  {t(locale, "petService.species_label")}
                </label>
                <div className="space-y-1">
                  {speciesOptions.map((opt) => (
                    ...
                    >
                      {opt === "all"
                        ? t(locale, "verticals.all_species")
                        : `${speciesEmoji(opt)} ${opt.charAt(0).toUpperCase() + opt.slice(1)}`}
                    </button>
                  ))}
                </div>
              </div>
            ...
            {filteredItems.length === 0 ? (
              <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
                ...
                <p className="text-ds-muted-foreground text-sm">
                  {t(locale, "petService.no_results_hint")}
                </p>
              </div>
            ) : (
                    ...
                    <div className="p-4">
                      ...
                      <div className="flex justify-between items-center pt-3 mt-3 border-t border-ds-border">
                        <span className="text-sm text-ds-muted-foreground">
                          {t(locale, "petService.pet_profile")}
                        </span>
                        <span className="px-3 py-1.5 text-xs font-semibold text-white bg-ds-destructive rounded-lg group-hover:bg-ds-destructive/90 transition-colors">
                          {t(locale, "petService.view_profile")}
                        </span>
                      </div>
                    </div>
                  </a>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-ds-foreground mb-2">
                {t(locale, "petService.step1_title")}
              </h3>
              <p className="text-sm text-ds-muted-foreground">
                {t(locale, "petService.step1_desc")}
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-ds-destructive text-white flex items-center justify-center text-xl font-bold mx-auto mb-4">
              ...
              <h3 className="font-semibold text-ds-foreground mb-2">
                {t(locale, "petService.step2_title")}
              </h3>
              <p className="text-sm text-ds-muted-foreground">
                {t(locale, "petService.step2_desc")}
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-ds-destructive text-white flex items-center justify-center text-xl font-bold mx-auto mb-4">
              ...
              <h3 className="font-semibold text-ds-foreground mb-2">
                {t(locale, "petService.step3_title")}
              </h3>
              <p className="text-sm text-ds-muted-foreground">
                {t(locale, "petService.step3_desc")}
              </p>
            </div>
          </div>
        </div>
