  ...
  loader: async ({ params }) => {
    try {
      ...
      const resp = await fetchWithTimeout(
        `${baseUrl}/store/pet-services/${params.id}`,
        {
          headers: {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
            ...
            <p className="text-ds-muted-foreground mb-6">
              This pet service may have been removed or is no longer available.
            </p>
            <Link
              to={`${prefix}/pet-services` as never}
                  ...
                  <div className="flex items-center gap-1.5 text-sm text-ds-muted-foreground">
                    <span className="text-lg">
                      {service.species === "dog"
                        ...
                        : service.species === "cat"
                          ? "🐱"
                          : service.species === "bird"
                            ? "🦅"
                            : "🐾"}
                    </span>
                    <span>
                      {service.species} &middot; {service.breed}
                    </span>
                  </div>
                )}
                {service.rating && (
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                {service.date_of_birth && (
                  <div>
                    ...
                    <p className="text-sm font-medium text-ds-foreground">
                      {new Date(service.date_of_birth!).toLocaleDateString(
                        "en-US",
              ...
              <div className="bg-ds-background border border-ds-border rounded-xl p-6">
                ...
                <div className="space-y-3">
                  {service.packages.map((pkg: any, idx: number) => (
                    <div
                      key={idx}
                      className="p-4 border border-ds-border rounded-lg hover:border-ds-primary transition-colors"
                    >
                      <div className="flex justify-between items-start">
                        ...
                        {pkg.price != null && (
                          <p className="font-bold text-ds-primary">
