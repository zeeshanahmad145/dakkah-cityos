...
export const Route = createFileRoute("/$tenant/$locale/subscriptions/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Browse subscription plans on Dakkah CityOS",
      },
    ],
  }),
  loader: async () => {
    try {
      ...
      const items = raw.map((s: any) => {
        ...
        return {
          id: s.id,
          name:
            meta.name || s.name || s.plan_name || s.title || "Untitled Plan",
          ...
          thumbnail:
            s.thumbnail || meta.thumbnail || meta.image || s.thumbnail || null,
...
function SubscriptionsPage() {
  ...
  const filteredItems = items.filter((item: any) => {
    ...
    const matchesInterval =
      intervalFilter === "all" || item.billing_interval === intervalFilter
      ...
      <div className="bg-gradient-to-r from-ds-primary to-ds-primary text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-white/80 max-w-2xl mx-auto">
            Choose the perfect subscription plan for your needs. Flexible
          ...
          <div className="mt-6 flex items-center justify-center gap-4 text-sm text-white/60">
            ...
            <span>
              {t(
                locale,
                "subscriptions.badge_free_trial",
                "Free trial included",
              )}
            </span>
            <span>|</span>
            <span>
              {t(
                locale,
                "subscriptions.badge_cancel_anytime",
                "Cancel anytime",
              )}
            </span>
          </div>
              ...
              <div>
                ...
                <div className="space-y-1">
                  {intervalOptions.map((opt) => (
                    ...
                    >
                      {opt === "all"
                        ? t(locale, "verticals.all_intervals")
            ...
            {filteredItems.length === 0 ? (
              <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
                ...
                <h3 className="text-lg font-semibold text-ds-foreground mb-2">
                  {t(locale, "subscriptions.no_results")}
                </h3>
                ...
                {filteredItems.map((item: any) => (
                  ...
                  >
                    <div className="bg-gradient-to-br from-ds-primary to-ds-primary p-6 text-white text-center relative">
                      {item.is_popular && (
                        <span className="absolute top-2 end-2 px-2 py-1 text-xs font-bold bg-ds-card text-ds-primary rounded-full">
                          Popular
                        </span>
                      )}
                    ...
                    <div className="p-5">
                      ...
                      {item.features && (item.features as string[]).length > 0 && (
                        <ul className="space-y-2 mb-4">
                          {(item.features as string[]).slice(0, 6)
                            .map((f: string, i: number) => (
                              ...
                              >
                                <svg
                                  className="w-4 h-4 text-ds-primary mt-0.5 flex-shrink-0"
                                  fill="none"
                                  viewBox="0 0 24 24"
                                  stroke="currentColor"
                                >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Enjoy a free trial period to explore all the features.
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-ds-primary text-white flex items-center justify-center text-xl font-bold mx-auto mb-4">
