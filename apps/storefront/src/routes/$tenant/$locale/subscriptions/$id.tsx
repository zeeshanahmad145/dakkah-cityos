  ...
  loader: async ({ params }) => {
    try {
      ...
      const resp = await fetchWithTimeout(
        `${baseUrl}/store/subscriptions/${params.id}`,
        {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
            ...
            <p className="text-ds-muted-foreground mb-6">
              This subscription plan may have been removed or is no longer
              available.
            </p>
            <Link
            ...
            <div className="relative aspect-[16/9] bg-ds-muted rounded-xl overflow-hidden">
              {plan.thumbnail || plan.image ? (
                ...
                <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-ds-primary/10 to-ds-primary/15">
                  <svg
                    className="w-16 h-16 text-ds-primary/70"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
              ...
              <div className="bg-ds-background border border-ds-border rounded-xl p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {features.map((feature: any, idx: number) => (
                    ...
                    >
                      <svg
                        className="w-4 h-4 mt-0.5 text-ds-success flex-shrink-0"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
            ...
            <div className="sticky top-4 space-y-6">
                ...
                <div className="text-center">
                  ...
                  {plan.annual_price && (
                    <p className="text-xs text-ds-muted-foreground mt-1">
                      or ${Number(plan.annual_price || 0).toLocaleString()}/year
                      (save {plan.annual_savings || "~17%"})
                    </p>
                  )}
                </div>
              ...
              <div className="bg-ds-primary/10 border border-ds-primary/30 rounded-xl p-6">
                ...
                <p className="text-sm text-ds-primary">
                  No long-term contracts. You can cancel, upgrade, or downgrade
