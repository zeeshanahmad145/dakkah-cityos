...
const fallbackItems = [
  ...
  },
  {
    ...
    description:
      "Trade in your MacBook Pro for instant credit. M1, M2, and M3 models accepted.",
    condition_requirements:
      "Functional display, keyboard works, no water damage",
    trade_in_min: 45000,
    trade_in_max: 120000,
  },
  {
    ...
    description:
      "Get credit for your used iPad. All generations and sizes welcome.",
  ...
  },
  {
    ...
    condition_requirements:
      "Disc drive works (if applicable), controller included",
    trade_in_min: 20000,
    trade_in_max: 35000,
  },
  {
    ...
    description:
      "Trade in your Galaxy S24 Ultra. Unlocked and carrier models accepted.",
  ...
  },
  {
    ...
    description:
      "Trade in your AirPods Pro for credit. Case and earbuds required.",
    condition_requirements: "Both earbuds work, case charges, no water damage",
    trade_in_min: 5000,
    trade_in_max: 12000,
  },
]
...
export const Route = createFileRoute("/$tenant/$locale/trade-in/")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Browse trade-in options on Dakkah CityOS",
      },
    ],
  }),
  loader: async () => {
      ...
      <div className="bg-gradient-to-r from-ds-success to-ds-success text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-6 flex items-center justify-center gap-4 text-sm text-white/60">
            ...
            <span>|</span>
            <span>
              {t(locale, "tradeIn.badge_instant_credit", "Instant credit")}
            </span>
            <span>|</span>
            <span>
              {t(locale, "tradeIn.badge_free_shipping", "Free shipping")}
            </span>
          </div>
        </div>
      </div>
            ...
            <div className="bg-ds-background border border-ds-border rounded-xl p-4 space-y-6 sticky top-4">
              <div>
                ...
                <input
                  ...
                  placeholder={t(locale, "trade_in.search_placeholder")}
                ...
                {filteredItems.map((item: any) => (
                  ...
                  >
                    <div className="aspect-[4/3] bg-gradient-to-br from-ds-success/10 to-ds-success/10 relative overflow-hidden">
                      ...
                      <span className="absolute top-2 start-2 px-2 py-1 text-xs font-medium bg-ds-success text-white rounded-md capitalize">
                        {item.category}
                      </span>
                      {item.trade_in_max && (
                        <span className="absolute top-2 end-2 px-2 py-1 text-xs font-bold bg-ds-card/90 text-ds-success rounded-md">
                          Up to {formatPrice(item.trade_in_max ?? 0)}
                        </span>
                      )}
                    </div>
                    <div className="p-4">
                      ...
                      {item.condition_requirements && (
                        <div className="mt-3 p-2.5 bg-ds-success/10 rounded-lg">
                          <p className="text-xs font-medium text-ds-success mb-1">
                      ...
                      <div className="mt-3 space-y-1.5">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-lg font-bold text-ds-success">
                            {formatPrice(item.trade_in_min ?? 0)} —{" "}
                            {formatPrice(item.trade_in_max ?? 0)}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="flex justify-between items-center pt-3 mt-3 border-t border-ds-border">
                        ...
                        <span className="px-4 py-1.5 text-xs font-semibold text-white bg-ds-success rounded-lg group-hover:bg-ds-success/90 transition-colors">
                          {t(locale, "trade_in.start_trade_in")}
                        </span>
                      </div>
                    </div>
                  </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-ds-muted-foreground">
                We send you a prepaid shipping label. Pack and ship your device.
              </p>
            </div>
            <div className="text-center">
              <div className="w-12 h-12 rounded-full bg-ds-success text-white flex items-center justify-center text-xl font-bold mx-auto mb-4">
              ...
              <p className="text-sm text-ds-muted-foreground">
                Receive store credit or payment once we verify your device.
              </p>
            </div>
          </div>
        </div>
