...
function getFallbackItems() {
  ...
  return [
    ...
    { id: "fd-3", name: "Designer Leather Handbag", category: "fashion", thumbnail: "/seed-images/flash-sales%2F1495474472287-4d71bcdd2085.jpg", original_price: 24999, sale_price: 12499, discount_percentage: 50, end_date: new Date(now + 2 * 60 * 60 * 1000).toISOString(), stock_remaining: 5, description: "Italian genuine leather, limited edition" },
    { id: "fd-4", name: "Organic Skincare Bundle", category: "beauty", thumbnail: "/seed-images/content%2F1558171813-4c088753af8f.jpg", original_price: 8999, sale_price: 3599, discount_percentage: 60, end_date: new Date(now + 8 * 60 * 60 * 1000).toISOString(), stock_remaining: 23, description: "5-piece set with cleanser, toner, serum, moisturizer & mask" },
    ...
    { id: "fd-6", name: "Running Shoes Ultra Boost", category: "sports", thumbnail: "/seed-images/trade-in%2F1542291026-7eec264c27ff.jpg", original_price: 17999, sale_price: 8999, discount_percentage: 50, end_date: new Date(now + 6 * 60 * 60 * 1000).toISOString(), stock_remaining: 15, description: "Lightweight with responsive cushioning" },
    { id: "fd-7", name: "4K Ultra HD Smart TV 55\"", category: "electronics", thumbnail: "/seed-images/content%2F1573164713988-8665fc963095.jpg", original_price: 79999, sale_price: 47999, discount_percentage: 40, end_date: new Date(now + 4 * 60 * 60 * 1000).toISOString(), stock_remaining: 7, description: "HDR10+, Dolby Vision, built-in streaming" },
    { id: "fd-8", name: "Luxury Perfume Gift Set", category: "beauty", thumbnail: "/seed-images/content%2F1454165804606-c3d57bc86b40.jpg", original_price: 15999, sale_price: 7999, discount_percentage: 50, end_date: new Date(now + 10 * 60 * 60 * 1000).toISOString(), stock_remaining: 18, description: "3 signature fragrances in premium packaging" },
  ]
}
