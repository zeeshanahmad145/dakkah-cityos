  ...
  loader: async ({ params }) => {
    try {
      ...
      const resp = await fetchWithTimeout(
        `${baseUrl}/store/government/${params.id}`,
        {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-ds-background border border-ds-border rounded-xl p-12 text-center">
            ...
            <p className="text-ds-muted-foreground mb-6">
              This government service may have been removed or is no longer
              available.
            </p>
            <Link
              to={`${prefix}/government` as never}
              ...
              <div className="bg-ds-background border border-ds-border rounded-xl p-6">
                ...
                <div className="space-y-3">
                  {service.requirements.map((req: any, idx: number) => (
                    ...
                    >
                      <span className="w-6 h-6 bg-ds-primary/10 rounded-full flex items-center justify-center text-ds-primary text-xs font-semibold flex-shrink-0">
                        {idx + 1}
                      </span>
            ...
            {service.office_locations &&
              service.office_locations.length > 0 && (
                <div className="bg-ds-background border border-ds-border rounded-xl p-6">
                  ...
                  <div className="space-y-3">
                    {service.office_locations.map(
                      (office: any, idx: number) => (
                        <div
                          key={idx}
                          className="flex items-start gap-3 p-3 bg-ds-muted/30 rounded-lg"
                        >
